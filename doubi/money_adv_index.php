...
$one = $db->get_row("select * from card_product where id='$id'");
if(empty($one)){exit();}
...
<div class="price-item">
	...
	<div class="btn-tab" onclick="location.href='money_adv_address.php?id=<?php echo $one['id'];?>&price=<?php echo $one['present_price'];?>'">
		<a class="btn-buy" href="javascript:void(0);">立即购买</a>
	</div>
</div>
...
<div class="btn-item btn-buy" onclick="location.href='money_adv_address.php?id=<?php echo $one['id'];?>&price=<?php echo $one['present_price'];?>'">
