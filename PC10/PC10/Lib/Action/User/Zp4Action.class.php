 ...
 *  银波米业1
 **/
class Zp4Action extends TableAction {
    /**
     *  定义项目模板BaseDir
     **/
...
/*     			array(
	...
	public function index(){
		...
		$this->table(
        	array(
            	...
            	'HeadHover' => U('Zp4/index', array('token' => $this->_sToken)),//栏目样式 
            	'Head_Opt' => array(
                	array(
                    	'name'   => '添加图片',//2级
                    	'url'    => U('Zp4/add_pinzhong')
                	)
            	),
                'tips' => array(//3级
                    '你可以在这里管理图片信息'
            	...
            	'List_Opt' => array(
                	array(
                    	'name' => '编辑',
                    	'url'  => U('Zp4/PinzhongEdit')
                	),
	                array(
	                    'name' => '删除',
	                    'url'  => U('Zp4/PinzhongDel')
	                ),
            	)
        	), 
	...
	public function order(){
		...
		$aInfo  = $Model->table('tp_miye_order o')
			...
			->join('tp_Zp4 pz on pz.id = o.pinzhong_id')
...
/* 		$list=M('Zp42')->select();//被添加内容的表
		...
		$this->$aaa('Zp4',array(
				...
				array('type'=>'img','many'=>array(
						...
						array('title'=>"屏幕上方图片",'type'=>"img",'name'=>"pic2",'value'=>'pic2','width'=>341,'height'=>215),
						array('title'=>"中间文字图片1",'type'=>"img",'name'=>"pic3",'value'=>'pic3','width'=>51,'height'=>155),
						array('title'=>"中间文字图片2",'type'=>"img",'name'=>"pic4",'value'=>'pic4','width'=>52,'height'=>157),
						array('title'=>"中间文字图片3",'type'=>"img",'name'=>"pic5",'value'=>'pic5','width'=>50,'height'=>153),
						array('title'=>"中间文字图片4",'type'=>"img",'name'=>"pic6",'value'=>'pic6','width'=>50,'height'=>152),
    ...
    public function add_pinzhong(){
    	...
    	$b=M('Zp4')->where(array('token'=>$token))->find();
    	if($b){
