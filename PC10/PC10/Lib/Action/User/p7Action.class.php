...
class Zp2Action extends TableAction {
    ...
    protected function setHeader(){
    	return array(
                ...
                array(
                    'name' => '门店管理',
                    'url'  => U('Zp2/dianpu', array('token' => $this->_sToken))
                ),
                array(
                    'name' => '订单管理',
                    'url'  => U('Zp2/order', array('token' => $this->_sToken))
                ),
                array(
                    'name' => 'logo管理',
                    'url'  => U('Zp2/uploadIcon', array('token' => $this->_sToken))
                ),
            );
    }
...
/* 		$list=M('Zp22')->select();//被添加内容的表
		...
		$this->$aaa('Zp2',array(
				...
				array('type'=>'img','many'=>array(
						array('title'=>"屏幕下方图片",'type'=>"img",'name'=>"pic",'value'=>'pic','whidth'=>310,'height'=>118),
