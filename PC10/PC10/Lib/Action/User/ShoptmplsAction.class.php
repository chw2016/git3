...
class ShoptmplsAction extends UserAction {
    ...
    public function add() {
        ...
        switch ($gets) {
            ...
            case 13:
                ...
                $data['shoptpltypename'] = '113_index';
                break;
            case 14:
                $data['shoptpltypeid'] = 14;
                $data['shoptpltypename'] = '114_index';
                break;
			case 15:
                $data['shoptpltypeid'] = 15;
                $data['shoptpltypename'] = '115_index';
                break;
            case 16:
                $data['shoptpltypeid'] = 16;
                $data['shoptpltypename'] = '116_index';
                break;
            case 17:
                $data['shoptpltypeid'] = 17;
                $data['shoptpltypename'] = '117_index';
                break;
            case 18:
                $data['shoptpltypeid'] = 18;
                $data['shoptpltypename'] = '118_index';
                break;
            case 19:
                $data['shoptpltypeid'] = 19;
                $data['shoptpltypename'] = '119_index';
                break;
            case 20:
    ...
    public function lists(){
        ...
        switch ($gets) {
            case 1 :
                $data ['shoptpllistid'] = 1;
                $data ['shoptpllistname'] = '100_products';
                break;
            case 2 :
                $data ['shoptpllistid'] = 2;
                $data ['shoptpllistname'] = '101_products';
                break;
            case 3:
                $data['shoptpllistid'] = 3;
                $data['shoptpllistname'] = '114_index';
                break;
        }
        $where['token'] = session('token');
        $db->where($where)->save($data);
    ...
    public function stores(){
        ...
        switch ($gets) {
            case 1 :
                $data ['shoptplcontentid'] = 1;
                $data ['shoptplcontentname'] = 'product1';
                break;
            case 2 :
                $data ['shoptplcontentid'] = 2;
                $data ['shoptplcontentname'] = 'product2';
                break;
        }
        $where['token'] = session('token');
        $db->where($where)->save($data);
