...
class WxHongBaoHelper
{
    ...
    public $partnerkey = '';
    public $token='';
	function __construct($partnerkey,$token)
	{
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT,dirname(__FILE__).DIRECTORY_SEPARATOR.'zhengshu'.DIRECTORY_SEPARATOR.$this->token.DIRECTORY_SEPARATOR.'apiclient_cert.pem');
 		curl_setopt($ch,CURLOPT_SSLKEY,dirname(__FILE__).DIRECTORY_SEPARATOR.'zhengshu'.DIRECTORY_SEPARATOR.$this->token.DIRECTORY_SEPARATOR.'apiclient_key.pem');
 		curl_setopt($ch,CURLOPT_CAINFO,dirname(__FILE__).DIRECTORY_SEPARATOR.'zhengshu'.DIRECTORY_SEPARATOR.$this->token.DIRECTORY_SEPARATOR.'rootca.pem');
