function FastClick(e, t) {
    ...
    this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = t.touchBoundary || 10, this.layer = e, this.tapDelay = t.tapDelay || 200, !FastClick.notNeeded(e)) {
        for (var o = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], r = this, a = 0, s = o.length; s > a; a++) r[o[a]] = i(r[o[a]], r);
...
function wxReady(e) {
    if (window.location.search.indexOf("debug_wx") >= 0) return void alert("debug wx");
...
function(e) {
    ...
    function i(e, t) {
        var i, n, o, r, a, s, l, c, d, u, f, h = t && t.split("/"),
        p = g.map,
        m = p && p["*"] || {};
        if (e && "." === e.charAt(0)) if (t) {
            for (h = h.slice(0, h.length - 1), e = e.split("/"), a = e.length - 1, g.nodeIdCompat && k.test(e[a]) && (e[a] = e[a].replace(k, "")), e = h.concat(e), d = 0; d < e.length; d += 1) if (f = e[d], "." === f) e.splice(d, 1),
            d -= 1;
            else if (".." === f) {
        ...
        if ((h || m) && p) {
            for (i = e.split("/"), d = i.length; d > 0; d -= 1) {
                if (n = i.slice(0, d).join("/"), h) for (u = h.length; u > 0; u -= 1) if (o = p[h.slice(0, u).join("/")], o && (o = o[n])) {
                    r = o,
                    s = d;
                    break
                }
                if (r) break; ! l && m && m[n] && (l = m[n], c = d)
            } ! r && l && (r = l, s = c),
            r && (i.splice(0, s, r), e = i.join("/"))
        }
        return e
    }
    function n(t, i) {
    ...
    function a(i) {
        ...
        if (!t(h, i) && !t(m, i)) throw new Error("No " + i);
        return h[i]
    }
    function s(e) {
    ...
    u = function(e, t) {
        ...
        return e = r[1],
        l && (l = i(l, t), n = a(l)),
        l ? e = n && n.normalize ? n.normalize(e, o(t)) : i(e, t) : (e = i(e, t), r = s(e), l = r[0], e = r[1], l && (n = a(l))),
        {
            f: l ? l + "!" + e: e,
            n: e,
            pr: l,
    ...
    c = function(i, o, s, l) {
        ...
        if (l = l || i, "undefined" === y || "function" === y) {
            for (o = !o.length && s.length ? ["require", "exports", "module"] : o, w = 0; w < o.length; w += 1) if (v = u(o[w], l), d = v.f, "require" === d) b[w] = f.require(i);
            else if ("exports" === d) b[w] = f.exports(i),
            k = !0;
            else if ("module" === d) c = b[w] = f.module(i);
            else if (t(h, d) || t(p, d) || t(m, d)) b[w] = a(d);
            else {
                if (!v.p) throw new Error(i + " missing " + d);
                v.p.load(v.n, n(l, !0), r(d), {}),
                b[w] = h[d]
            }
            g = s ? s.apply(h[i], b) : void 0,
            i && (c && c.exports !== e && c.exports !== h[i] ? h[i] = c.exports: g === e && k || (h[i] = g))
        } else i && (h[i] = s)
    },
    requirejs = require = d = function(t, i, n, o, r) {
        if ("string" == typeof t) return f[t] ? f[t](i) : a(u(t, i).f);
        if (!t.splice) {
        ...
        o ? c(e, t, i, n) : setTimeout(function() {
            c(e, t, i, n)
        },
        4),
        d
...
$(function() {
    ...
    t = $("body"),
    i = $("html").hasClass("wx_mobile") && e.mp_data && +e.mp_data.quick_subscribe && e.mp_data.quick_subscribe_url,
    n = {
        fav: function() {
        ...
        follow: function(e) {
            var t = e || {},
            i = ['<div id="js-follow-guide" class="js-fullguide fullscreen-guide follow-guide hide"><span class="js-close-guide guide-close">&times;</span><div class="guide-inner"><div class="step step-2"></div><div class="wxid"><strong>', t.mp_weixin, '</strong></div><div class="step step-3"></div></div></div>'];
            return i.join("")
        },
        goodsFollow: function(e) {
            var t = e || {},
            i = ['<div id="js-follow-guide" class="js-fullguide fullscreen-guide follow-guide hide"><span class="js-close-guide guide-close">&times;</span><div class="guide-inner"><h3 class="guide-inner-title">你需要关注后才能购买</h3><div class="step step-2"></div><div class="wxid"><strong>', t.mp_weixin, '</strong></div><div class="step step-3"></div></div></div>'];
            return i.join("")
        },
        goodsQuickSubscribe: function(e) {
            var t = e || {},
            i = ['<div id="js-follow-guide" class="js-fullguide fullscreen-guide follow-guide hide"><div class="quick-subscribe js-quick-subscribe"><h2>请先关注后再购买，享受更好的服务~</h2><div><a class="btn" href="', t.quick_subscribe_url, '">去关注</a ></div></div></div>'];
            return i.join("")
        },
        pc: function(e) {
            var t = e || {},
            i = ['<div id="js-share-guide" class="js-fullguide fullscreen-guide hide" style="font-size: 20px; line-height: 30px; color: #fff; text-align: center;"> <span class="js-close-guide guide-close">&times;</span> <div class="guide-inner"> 通过微信【扫一扫】功能<br/>扫描二维码关注我们<img style="width:160px; height: 160px;margin-top: 20px;" src="http://open.weixin.qq.com/qr/code/?username=', t.mp_weixin, '" alt="', t.mp_weixin, '"> </div> </div> '];
            return i.join("")
        }
    },
    o = {
    ...
    r = function(e, t) {
        var i, r;
        $(o[e]).length ? r = $(o[e]) : (i = n[e](t || {}), r = $(i).appendTo("body")),
        r.removeClass("hide")
    },
    a = {
        fav: function() {
    ...
    e.is_mobile ? e && "Showcase_Goods_Controller" === e.controller && (n.follow = i ? n.goodsQuickSubscribe: n.goodsFollow) : n.follow = n.pc,
    t.on("click", ".wxid",
    function(e) {
        e.stopPropagation()
    }),
    ...
    $(document.documentElement).on("click", ".js-fullguide",
    function() {
        $(this).addClass("hide")
    }),
...
$.extend(window.Utils, {
    ...
    addParameter: function(e, t) {
        ...
        for (var n in t) if (t.hasOwnProperty(n)) {
            ...
            if (e.indexOf("?") < 0) e += "?" + $.trim(n) + "=" + $.trim(t[n]);
            else {
                var o = {},
                r = e.split("?");
                $.each(r[1].split("&"),
...
FastClick.prototype.onTouchStart = function(e) {
    ...
    if (t = this.getTargetElementFromEventTarget(e.target), i = e.targetTouches[0], deviceIsIOS) {
        ...
        if (!deviceIsIOS4) {
            if (i.identifier === this.lastTouchIdentifier) return e.preventDefault(),
            !1;
...
FastClick.prototype.onTouchEnd = function(e) {
    ...
    } else if (this.needsFocus(a)) return e.timeStamp - i > 100 || deviceIsIOS && window.top !== window && "input" === n ? (this.targetElement = null, !1) : (this.focus(a), this.sendClick(a, e), deviceIsIOS && "select" === n || (this.targetElement = null, e.preventDefault()), !1);
...
function(e) {
    ...
    e.extend(e.kdt, {
        ...
        spm: function() {
            ...
            if (t = e.trim(t), "" !== t) {
                var i = t.split("_");
                i.length > 2 && (t = i[0] + "_" + i[i.length - 1]),
                window._global.spm.logType && window._global.spm.logId && (t += "_" + window._global.spm.logType + window._global.spm.logId)
        ...
        isWeixin: function() {
            return e.kdt._weixinEle = e.kdt._weixinEle || e(document.documentElement),
            e.kdt._weixinEle.hasClass("wx_mobile")
        },
        isIPad: function() {
        ...
        openModal: function() {
            this._opened || (e.kdt.isIOS() ? (e.kdt.getTaobaoModal().find(".js-step-2").addClass("step-2"), this._opened = !0) : e.kdt.isAndroid() && (e.kdt.getTaobaoModal().find(".js-step-2").addClass("step-and-2"), this._opened = !0)),
...
function(e, t, i, n) {
    ...
    e.fn.lazyload = function(r) {
        ...
        return r && (n !== r.failurelimit && (r.failure_limit = r.failurelimit, delete r.failurelimit), n !== r.effectspeed && (r.effect_speed = r.effectspeed, delete r.effectspeed), e.extend(c, r)),
        ...
        this.each(function() {
            ...
            i = e(t);
            t.loaded = !1,
            (i.attr("src") === n || i.attr("src") === !1) && i.is("img") && c.placeholder && i.attr("src", c.placeholder),
            i.one("appear",
            function() {
                if (!this.loaded) {
                    if (c.appear) {
    ...
    e.belowthefold = function(i, r) {
        var a;
        return a = r.container === n || r.container === t ? (t.innerHeight ? t.innerHeight: o.height()) + o.scrollTop() : e(r.container).offset().top + e(r.container).height(),
        a <= e(i).offset().top - r.threshold
    },
    e.rightoffold = function(i, r) {
        var a;
        return a = r.container === n || r.container === t ? o.width() + o.scrollLeft() : e(r.container).offset().left + e(r.container).width(),
        a <= e(i).offset().left - r.threshold
    },
    e.abovethetop = function(i, r) {
        var a;
        return a = r.container === n || r.container === t ? o.scrollTop() : e(r.container).offset().top,
        a >= e(i).offset().top + r.threshold + e(i).height()
    },
    e.leftofbegin = function(i, r) {
        var a;
        return a = r.container === n || r.container === t ? o.scrollLeft() : e(r.container).offset().left,
        a >= e(i).offset().left + r.threshold + e(i).width()
    },
...
function() {
    ...
    $.kdt.clickLogHandler = function(t) {
        function i() {
            var i = $.Deferred().done(function() { ($.kdt.isMobile() || !r) && $.kdt.openLink(c)
            }),
            n = {
                spm: e,
                fm: "click",
        ...
        var n = $(this),
        o = n.attr("href"),
        r = "_blank" === n.attr("target"),
        a = n.data("goods-id"),
        s = n.prop("title") || n.text(),
        l = $.trim(o);
        if ("" !== l && 0 !== l.indexOf("javascript") && 0 !== l.indexOf("tel") && !n.hasClass("js-no-follow")) {
            var c = o;
            o.match(/^https?:\/\/\S*\.?(koudaitong\.com|kdt\.im|youzan\.com)/) && (c = Utils.addParameter(o, {
                spm: e
            })),
            i(),
            $.kdt.isMobile() || !r ? t.preventDefault() : n.attr("href", c)
        }
    },
    ...
    $(".js-goods-lazy").lazyload({
        ...
        appear: function() {
            ...
            t = e.lastIndexOf("_") === e.length - 1 ? e + "SI" + i: e + "_SI" + i,
            $.kdt.log(Utils.addParameter(_global.logURL, {
                spm: t,
                fm: "display",
                referer_url: encodeURIComponent(document.referrer)
            }))
    ...
    var o = ($(document.documentElement), $(".js-mp-info")),
    r = window.navigator.userAgent,
    a = r.match(/MicroMessenger\/(\d+(\.\d+)*)/),
    s = null !== a && a.length,
    l = s ? a[1] : "",
    c = l.split("."),
    d = [5, 2, 0],
    ...
    var h = $.kdt.isAndroid() && $.kdt.isWeixin() && u;
    h || o.on("click", ".js-follow-mp",
    function() {
...
function() {
    var e = Utils.getParameterByName("promote"),
    t = Utils.getParameterByName("from"),
    i = $("a");
    e && i.each(function() {
        var t = $(this),
        i = t.attr("href");
        i = Utils.addParameter(i, {
            promote: e
        }),
        i && 0 !== i.indexOf("tel") && t.attr("href", i)
    }),
    t && i.each(function() {
        var e = $(this),
        i = e.attr("href");
        ...
        i && 0 !== i.indexOf("tel") && e.attr("href", i)
    })
} (),
function() {
    setTimeout(function() {
        ...
        var t = "http://open.weixin.qq.com/qr/code/?username=" + window._global.mp_data.mp_weixin,
        i = new Image;
        i.width = 158,
        i.height = 158,
        $(i).on("load",
...
function() {
    ...
    n = function() {
        ...
        t = $("#wxcover"),
        n = null;
        return t && t.length > 0 ? (n = t.data("wxcover"), n && 0 !== n.length || (n = t.css("background-image"), n && "none" != n ? (n = /^url\((['"]?)(.*)\1\)$/.exec(n), n = n ? n[2] : null) : n = null)) : (t = null, $(".content img").each(function(e, i) {
            return $(i).hasClass("js-not-share") ? void 0 : (t = $(i), !1)
        }), t && t.length > 0 && (n = t[0].getAttribute("src") || t[0].getAttribute("data-src"))),
        i(n || (window._global.mp_data || {}).logo || e)
    },
    o = function() {
        var e = window._global.current_page_link || document.documentURI,
        t = Number(window._global.kdt_id) || 0,
        i = "shop" + (192168 + t);
        if ( - 1 !== e.indexOf("open.weixin.qq.com")) {
            e = decodeURIComponent(e);
            var n = e.match(/redirect_uri\=(.*?)[\&|\$]/i);
            if (!n) return ! 1;
            n.length > 1 && n[1] && -1 === n[1].indexOf("/x/") && (n = e.match(/state=(.*?)[\#|\&|\$]/i)),
            e = n.length > 1 ? n[1] : !1
        }
        return t > 0 && (e = e.replace("://wap.", "://" + i + ".")),
        e
    },
    r = function(e) {
        return t.sl ? Utils.addParameter(e, {
            sl: t.sl
        }) : e
    },
    a = function() {
        var e = t.title || window._global.title || $("#wxtitle").text() || document.title,
        i = r(t.link || o()),
        a = t.cover || n(),
        s = ((t.desc || $("#wxdesc").val() || $("#wxdesc").text() || $(".custom-richtext").text() || $(".content-body").text() || $(".content").text() || e || "") + "").replace(/\s*/g, "");
        return i = Utils.removeParameter(i, "redirect_count"),
        function() {
            e = window.__title || e,
            i = window.__link || i,
            a = window.__cover || a,
            s = window.__desc || s;
            var t, n = $(".time-line-title");
            return n.length > 0 && (t = n.val() || n.text()),
            {
                title: Utils.unescape(e),
                link: i,
                img_url: a,
                desc: Utils.unescape(s).substring(0, 80),
                img_width: "200",
                img_height: "200",
    ...
    wxReady(function() {
        ...
        e && (e.call(t.notShare ? "hideOptionMenu": "showOptionMenu"), e.call(window._global.js.hide_wx_nav ? "hideToolbar": "showToolbar"), e.on("menu:share:timeline",
        function() {
            if (!t.notShare) {
...
$(function() {
    wxReady(function() {
        window.WeixinJSBridge && "function" === (typeof window.WeixinJSBridge.invoke).toLowerCase() && window.WeixinJSBridge.invoke("getNetworkType", {},
        function(e) {
...
$.extend(window.Utils, {
    cookie: function() {
        ...
        return function(r, a) {
            ...
            var s = r + "=" + (a.value || "") + ";";
            delete a.value,
            void 0 !== a.expires && (e.setTime(t + a.expires * i), a.expires = e.toGMTString()),
            s += o(a, ";"),
            document.cookie = s
        }
    } ()
...
function() {
    ...
    !1);
    var e = localStorage.getItem("nobody_sign"),
    t = Utils.cookie("nobody_sign");
    "verified_by_account" !== window._global.verify_fans_merge && e && 0 !== e.length ? e !== t && Utils.cookie("nobody_sign", {
        value: e,
        expires: 365,
        domain: "koudaitong.com",
        path: "/"
    }) : localStorage.setItem("nobody_sign", t)
} ();