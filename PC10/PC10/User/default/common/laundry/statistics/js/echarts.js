...
define("zrender/tool/util", ["require", "../lib/excanvas"],
function(e) {
    function n(e) {
    ...
    function r(e, n, r, s) {
        if (n.hasOwnProperty(r)) if (typeof e[r] == "object" && !t[Object.prototype.toString.call(e[r])]) i(e[r], n[r], s);
...
function(e) {
    ...
    return function() {
        ...
        if (t.debugMode == 1) for (var e in arguments) throw new Error(arguments[e]);
...
function() {
    ...
    function i() {
        ...
        function s(n, r, i, s) {
            if (t[n]) {
                ...
                var a;
                for (var f = 0,
                l = t[n].length; f < l; f++) a = s || t[n][f].h,
                t[n][f].h.call(a, u),
                t[n][f].one || o.push(t[n][f]);
    ...
    var r = window.Event && Event.prototype.preventDefault ?
    function(e) {
        e.preventDefault(),
        e.stopPropagation()
    }: function(e) {
...
define("zrender/Handler", ["require", "./config", "./tool/env", "./tool/event"],
function(e) {
    function u(e, t) {
        return function(n) {
            return e.call(t, n)
    ...
    o = {
        resize: function(e) {
            ...
            this._isMouseDown = 0,
            this.dispatch(i.RESIZE, e)
        },
        click: function(e) {
            e = this._zrenderEventFixed(e);
            var t = this._lastHover; (t && t.clickable || !t) && this._dispatchAgency(t, i.CLICK, e),
            this._mousemoveHandler(e)
        },
        mousewheel: function(e) {
            e = this._zrenderEventFixed(e),
            this._dispatchAgency(this._lastHover, i.MOUSEWHEEL, e),
            this._mousemoveHandler(e)
        },
        mousemove: function(e) {
            ...
            if (!this._hasfound) {
                if (!this._draggingTarget || this._lastHover && this._lastHover != this._draggingTarget) this._processOutShape(e),
            ...
            this._dispatchAgency(this._lastHover, i.MOUSEMOVE, e),
        ...
        mousedown: function(e) {
            ...
            this._dispatchAgency(this._lastHover, i.MOUSEDOWN, e),
            this._lastDownButton = e.button
        },
        mouseup: function(e) {
            e = this._zrenderEventFixed(e),
            ...
            this._isMouseDown = 0,
            this._mouseDownTarget = null,
            this._dispatchAgency(this._lastHover, i.MOUSEUP, e),
            this._processDrop(e),
            this._processDragEnd(e)
        },
        ...
        touchend: function(e) {
            ...
            new Date - this._lastTouchMoment < i.touchClickDelay && (this._mobildFindFixed(e), this._clickHandler(e)),
            this.painter.clearHover()
        }
    };
    ...
    f.prototype._processDragStart = function(e) {
        ...
        if (this._isMouseDown && t && t.draggable && !this._draggingTarget && this._mouseDownTarget == t) {
            ...
            this._isDragging = 1,
            n.invisible = !0,
            this.storage.mod(n.id, n),
            this._dispatchAgency(n, i.DRAGSTART, e),
    ...
    f.prototype._processDragEnd = function(e) {
        this._draggingTarget && (this._dispatchAgency(this._draggingTarget, i.DRAGEND, e), this._lastHover = null),
        this._isDragging = 0,
    ...
    f.prototype._dispatchAgency = function(e, t, n, r) {
        ...
        r && (s.dragged = r),
        e ? (!e[i] || !e[i](s)) && this.dispatch(t, n, s) : r || this.dispatch(t, n)
    };
    var l = [{
        x: 10
    },
...
define("zrender/shape/Base", ["require", "../tool/matrix", "../tool/guid", "../tool/area", "../tool/area", "../tool/color", "../tool/area"],
function(e) {
    function r(t, n, r, s, o, u, a) {
        ...
        for (var c = 0,
        h = n.length; c < h; c++) t.fillText(n[c], r, s),
        s += l
    }
    ...
    s.prototype.brush = function(e, t) {
        ...
        n.text && this.drawText(e, n, this.style),
        e.restore()
    };
    ...
    s.prototype.getTansform = function(e, n) {
        ...
        if (this.needTransform && this._transform) {
            var i = [];
            t.invert(i, this._transform),
            t.mulVector(r, i, [e, n, 1]),
            e == r[0] && n == r[1] && this.updateNeedTransform()
        }
        return r
    },
    ...
    s.prototype.drawText = function(e, t, n) {
        ...
        case "right":
            if (this.getRect) {
                ...
                case "inside":
                    ...
                    o = "center",
                    u = "middle",
                    t.brushType != "stroke" && i == t.color && (e.fillStyle = "#fff");
                    break;
                case "left":
                    a = c.x - s,
                    f = c.y + c.height / 2,
        ...
        case "end":
            ...
            s -= 4,
            h != p ? a -= o == "end" ? s: -s: o = "center",
            d != v ? f -= u == "bottom" ? s: -s: u = "middle";
            break;
        case "specific":
            a = t.textX || 0,
            f = t.textY || 0,
    ...
    s.prototype.updateTransform = function(e) {
        ...
        if (this.scale && (this.scale[0] !== 1 || this.scale[1] !== 1)) {
            ...
            i = this.scale[3] || 0; (r || i) && t.translate(n, n, [ - r, -i]),
            t.scale(n, n, this.scale),
            (r || i) && t.translate(n, n, [r, i])
        }
        if (this.rotation) if (this.rotation instanceof Array) {
            if (this.rotation[0] !== 0) {
                var r = this.rotation[1] || 0,
                i = this.rotation[2] || 0; (r || i) && t.translate(n, n, [ - r, -i]),
                t.rotate(n, n, this.rotation[0]),
                (r || i) && t.translate(n, n, [r, i])
            }
        } else this.rotation !== 0 && t.rotate(n, n, this.rotation);
        this.position && (this.position[0] !== 0 || this.position[1] !== 0) && t.translate(n, n, this.position),
        this._transform = n,
        e.transform.apply(e, n)
    },
    s
}),
define("zrender/shape/Path", ["require", "./Base", "../tool/util"],
function(e) {
    function n(e) {
        t.call(this, e)
    }
...
define("zrender/tool/area", ["require", "../tool/util", "../shape/Path"],
function(e) {
    function a(e, r, i, s) {
        if (!r || !e) return ! 1;
        var o = e.type;
    ...
    function S(e, i) {
        ...
        var a = 0;
        for (var f = 0,
        l = e.length; f < l; f++) a = Math.max(n.measureText(e[f]).width, a);
        return n.restore(),
        r[o] = a,
        ++s > u && (s = 0, r = {}),
        a
    ...
    return s.prototype = {
        ...
        brush: function(e, i, s) {
            ...
            if (u) {
                ...
                this.style.width = l,
                this.style.height = c,
                o.text && this.drawText(e, o, this.style),
                e.restore()
            }
        },
        buildPath: function(e, t) {
...
define("zrender/Painter", ["require", "./config", "./tool/util", "./tool/log", "./loadingEffect/Base", "./shape/Image"],
function(e) {
    function u() {
        return ! 1
    }
    ...
    function f(e, t) {
        ...
        this._ctxListBack = {},
        this._zLevelConfig = {},
        this._maxZlevel = t.getMaxZlevel(),
        this._loadingEffect = new i({}),
        this.shapeToImage = this._createShapeToImageProcessor(),
        this._domList.bg = l("bg", "div", this),
        n.appendChild(this._domList.bg);
        var r, a;
        for (var f = 0; f <= this._maxZlevel; f++) r = l(f, "canvas", this),
        n.appendChild(r),
        this._domList[f] = r,
        o && o.initElement(r),
        this._ctxList[f] = a = r.getContext("2d"),
        s != 1 && a.scale(s, s);
        r = l("hover", "canvas", this),
        r.id = "_zrender_hover_",
        n.appendChild(r),
        this._domList.hover = r,
        o && o.initElement(r),
        this._domList.hover.onselectstart = u,
        this._ctxList.hover = a = r.getContext("2d"),
        s != 1 && a.scale(s, s)
    }
    function l(e, t, n) {
        ...
        r.style.width = i + "px",
        r.style.height = o + "px",
        r.setAttribute("width", i * s),
        r.setAttribute("height", o * s),
    ...
    return f.prototype.render = function(e) {
        ...
        this.clear(),
        this.storage.iterShape(this._brush({
            all: !0
        }), {
            normal: "up"
        }),
    ...
    f.prototype.refresh = function(e) {
        ...
        if (t.all) this.clear();
        else for (var n in t) this._ctxList[n] && this.clearLayer(n);
    ...
    f.prototype.clearHover = function() {
        ...
        return e && e.clearRect(0, 0, this._width * s, this._height * s),
        this
    },
        ...
        if (t) {
            ...
            if (r) {
                if (typeof this._domListBack[e] == "undefined") {
                    ...
                    u.width = o.width,
                    u.height = o.height,
                    u.style.width = o.style.width,
                    u.style.height = o.style.height,
                    this._domListBack[e] = u,
                    this._ctxListBack[e] = u.getContext("2d"),
                    s != 1 && this._ctxListBack[e].scale(s, s)
                }
                this._ctxListBack[e].globalCompositeOperation = "copy",
                this._ctxListBack[e].drawImage(o, 0, 0, o.width / s, o.height / s)
            }
            ...
            if (r) {
                ...
                a.save(),
                a.globalAlpha = i,
                a.drawImage(u, 0, 0, u.width / s, u.height / s),
                a.restore()
            }
    ...
    f.prototype.dispose = function() {
        ...
        this.root.innerHTML = "",
        this.root = this.storage = this._domRoot = this._domList = this._ctxList = this._ctxListBack = this._domListBack = null
    },
    ...
    f.prototype.toDataURL = function(e, n, i) {
        ...
        s != 1 && a.scale(s, s),
        a.fillStyle = n || "#fff",
        a.rect(0, 0, this._width * s, this._height * s),
        a.fill();
        var f = this;
        ...
        return a = null,
        this._domList.bg.removeChild(u),
        h
    },
    ...
    f.prototype._syncMaxZlevelCanvase = function() {
        ...
        if (this._maxZlevel < e) {
            for (var t = this._maxZlevel + 1; t <= e; t++) {
                ...
                this._domList[t] = n,
                this._domRoot.insertBefore(n, this._domList.hover),
                o && o.initElement(n);
    ...
    f.prototype._shapeToImage = function(t, n, r, i, s, o, u) {
        s.style.width = r + "px",
        s.style.height = i + "px",
        s.setAttribute("width", r * u),
        s.setAttribute("height", i * u),
        o.clearRect(0, 0, r * u, i * u);
        var a = {
            position: n.position,
            rotation: n.rotation,
            scale: n.scale
...
define("zrender/Storage", ["require", "./tool/util", "./tool/log", "./config"],
function(e) {
    function i() {
        this._elements = {},
        this._zElements = [],
    ...
    return i.prototype.iterShape = function(e, t) {
        ...
        if (t.hover) for (var n = 0,
        r = this._hoverElements.length; n < r; n++) if (e(this._hoverElements[n])) return this;
        var i, s;
        ...
        case "up":
            for (var n = 0,
            r = this._zElements.length; n < r; n++) {
                i = this._zElements[n];
                if (i) {
                    s = i.length;
    ...
    i.prototype.mod = function(e, n) {
        ...
        return r && (r.updateNeedTransform(), r.style.__rect = null, this._changedZlevel[r.zlevel] = !0, n && t.merge(r, n, !0), this._changedZlevel[r.zlevel] = !0, this._maxZlevel = Math.max(this._maxZlevel, r.zlevel)),
        this
    },
    ...
    i.prototype.addHover = function(e) {
        return e.rotation && Math.abs(e.rotation[0]) > 1e-4 || e.position && (Math.abs(e.position[0]) > 1e-4 || Math.abs(e.position[1]) > 1e-4) || e.scale && (Math.abs(e.scale[0] - 1) > 1e-4 || Math.abs(e.scale[1] - 1) > 1e-4) ? e.needTransform = !0 : e.needTransform = !1,
    ...
    i.prototype.add = function(e) {
        ...
        this._changedZlevel[e.zlevel] = !0,
        this
    },
    ...
    i.prototype.del = function(e) {
        if (typeof e != "undefined") {
            ...
            if (e instanceof Array) {
                if (e.lenth < 1) return;
                for (var n = 0,
                r = e.length; n < r; n++) t[e[n].id] = !0
            } else t[e] = !0;
            var i, s, o, u = {};
            for (var a in t) if (this._elements[a]) {
                o = this._elements[a].zlevel,
                this._changedZlevel[o] = !0;
                if (!u[o]) {
                    s = this._zElements[o],
                    i = [];
                    for (var n = 0,
                    r = s.length; n < r; n++) t[s[n].id] || i.push(s[n]);
                    this._zElements[o] = i,
                    u[o] = !0
                }
    ...
    i.prototype.setChangedZlevle = function(e) {
        return this._changedZlevel[e] = !0,
        this
    },
...
define("zrender/animation/animation", ["require", "./clip", "../tool/color"],
function(e) {
    function s(e) {
        e = e || {},
        this.stage = e.stage || {},
    ...
    function f(e, t, n, r, i) {
        var s = e.length;
        if (i == 1) for (var o = 0; o < s; o++) r[o] = a(e[o], t[o], n);
        else {
            var u = e[0].length;
    ...
    function c(e, t, n, r, i, s, o, u, a) {
        var f = e.length;
        if (a == 1) for (var l = 0; l < f; l++) u[l] = h(e[l], t[l], n[l], r[l], i, s, o);
        else {
            var c = e[0].length;
    ...
    var t = e("./clip"),
    n = e("../tool/color"),
    r = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame ||
    function(e) {
        setTimeout(e, 16)
    },
                ...
                var B = function(e, t) {
                    ...
                    if (u) {
                        ...
                        if (b) c(M, _, D, P, O, O * O, O * O * O, s(e, m), E);
                            ...
                            var l;
                            w ? (l = c(M, _, D, P, O, O * O, O * O * O, H, 1), l = d(H)) : l = h(M, _, D, P, O, O * O, O * O * O),
                            i(e, m, l)
                        }
                    } else if (b) f(T[N], T[N + 1], O, s(e, m), E);
                    else {
                        var l;
                        w ? (f(T[N], T[N + 1], O, H, 1), l = d(H)) : l = a(T[N], T[N + 1], O),
                        i(e, m, l)
                    }
...
define("zrender/zrender", ["require", "./lib/excanvas", "./tool/util", "./tool/log", "./tool/guid", "./Handler", "./Painter", "./Storage", "./animation/animation", "./tool/env"],
function(e) {
    function l(e) {
        return function() {
            var t = e.animatingShapes;
            for (var n = 0,
            r = t.length; n < r; n++) e.storage.mod(t[n].id);
    ...
    c.prototype.delShape = function(e) {
        return this.storage.del(e),
        this
    },
    c.prototype.modShape = function(e, t, n) {
        return this.storage.mod(e, t, n),
        this
    },
...
define("echarts/component/base", ["require", "../config", "../util/ecQuery", "../util/number", "zrender/tool/util", "zrender/tool/env"],
function(e) {
    function s(e, t, n, r, i) {
        ...
        s.hoverConnect = function(e) {
            ...
            if (t) {
                ...
                o = t.length; i < o; i++) r = s.getShapeById(t[i]),
                s.zr.addHoverShape(r),
                n = Math.min(n, r.zlevel);
                else r = s.getShapeById(t),
                r && (s.zr.addHoverShape(r), n = Math.min(n, r.zlevel));
    ...
    return s.prototype = {
        ...
        reformOption: function(e) {
            return i.merge(e || {},
            i.clone(this.ecTheme[this.type] || {}))
        },
        ...
        getShapeById: function(e) {
            for (var t = 0,
            n = this.shapeList.length; t < n; t++) if (this.shapeList[t].id == e) return this.shapeList[t];
            return null
        },
        getFont: function(e) {
            var t = i.merge(i.clone(e) || {},
...
define("zrender/shape/Heart", ["require", "./Base", "../tool/util"],
function(e) {
    function n(e) {
        t.call(this, e)
    }
...
define("zrender/shape/Droplet", ["require", "./Base", "../tool/util"],
function(e) {
    function n(e) {
        t.call(this, e)
    }
...
function(e) {
    ...
    return s.prototype = {
        ...
        brush: function(e, t) {
            ...
            this.updateTransform(e);
            var r = !1;
            if (n.brushType == "fill" || n.brushType == "both" || typeof n.brushType == "undefined") e.beginPath(),
            n.lineType == "dashed" || n.lineType == "dotted" ? (this.buildPath(e, {
                lineType: "solid",
                lineWidth: n.lineWidth,
                pointList: n.pointList
            }), r = !1) : (this.buildPath(e, n), r = !0),
            e.closePath(),
            e.fill();
        ...
        buildPath: function(e, t) {
            ...
            if (t.smooth && t.smooth !== "spline") {
                ...
                for (var c = 0; c < l; c++) u = o[c * 2],
                a = o[c * 2 + 1],
                f = s[(c + 1) % l],
                e.bezierCurveTo(u[0], u[1], a[0], a[1], f[0], f[1])
            } else {
                t.smooth === "spline" && (s = n(s, !0));
                if (!t.lineType || t.lineType == "solid") {
                    e.moveTo(s[0][0], s[0][1]);
                    for (var c = 1,
                    h = s.length; c < h; c++) e.lineTo(s[c][0], s[c][1]);
                    ...
                    e.moveTo(s[0][0], s[0][1]);
                    for (var c = 1,
                    h = s.length; c < h; c++) i(e, s[c - 1][0], s[c - 1][1], s[c][0], s[c][1], p);
...
define("zrender/shape/BrokenLine", ["require", "./Base", "./util/smoothSpline", "./util/smoothBezier", "./util/dashedLineTo", "./Polygon", "../tool/util"],
function(e) {
    function s(e) {
        this.brushTypeOnly = "stroke",
        this.textPosition = "end",
    ...
    return s.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            if (t.smooth && t.smooth !== "spline") {
                ...
                e.moveTo(s[0][0], s[0][1]);
                var a, f, l;
                for (var c = 0; c < o - 1; c++) a = u[c * 2],
                f = u[c * 2 + 1],
                l = s[c + 1],
                e.bezierCurveTo(a[0], a[1], f[0], f[1], l[0], l[1])
            } else {
...
define("echarts/util/shape/MarkLine", ["require", "zrender/shape/Base", "./Icon", "zrender/shape/Line", "zrender/shape/BrokenLine", "zrender/tool/matrix", "zrender/tool/area", "zrender/shape/util/dashedLineTo", "zrender/shape/util/smoothSpline", "zrender/tool/util"],
function(e) {
    function h(e) {
        t.call(this, e)
    }
    ...
    return h.prototype = {
        ...
        buildLinePath: function(e, t) {
            ...
            } else for (var i = 1; i < r; i += 2) e.moveTo(n[i - 1][0], n[i - 1][1]),
...
define("echarts/util/ecAnimation", ["require", "zrender/tool/util", "zrender/shape/Polygon"],
function(e) {
    ...
    function d(e, t, n, r, i) {
        ...
        }).start(i || "QuinticOut")) : (n.style.pointList = [[n.style.xStart, n.style.yStart], [n.style.xStart, n.style.yStart]], e.addShape(n), e.animate(n.id, "style").when(r, {
...
define("echarts/util/ecEffect", ["require", "../util/ecData", "zrender/shape/Circle", "zrender/shape/Image", "../util/shape/Icon", "../util/shape/Symbol", "zrender/tool/env"],
function(e) {
    function u(e, n, s, u) {
        var a = s.effect,
    ...
    function a(e, t, n, r) {
        ...
        p = {},
        d = {};
        for (var v = 0; v < 20; v++) c.style["randomMap" + v] = 0,
        p = {},
        p["randomMap" + v] = 100,
        d = {},
        d["randomMap" + v] = 0,
...
define("echarts/chart/base", ["require", "zrender/shape/Image", "../util/shape/Icon", "../util/shape/MarkLine", "../util/shape/Symbol", "../config", "../util/ecData", "../util/ecAnimation", "../util/ecEffect", "../util/accMath", "zrender/tool/util", "zrender/tool/area"],
function(e) {
    function h() {
        var e = this;
        this.selectedMap = {},
    ...
    return h.prototype = {
        ...
        ondrop: function(e, t) {
            ...
            if (u == -1) {
                ...
                p = a[i].data;
                for (var d = 0,
                v = p.length; d < v; d++) p[d].name == l.name && p[d].value == "-" && (a[i].data[d].value = l.value, h = !0); ! h && a[i].data.push(l),
                ...
                if (typeof l.value != "undefined") {
                    ...
                    if (this.type == s.CHART_TYPE_FUNNEL || this.type == s.CHART_TYPE_PIE) c && c.getRelatedAmount(l.name) == 1 && this.component.legend.del(l.name),
                    l.name += this.option.nameConnector + o.get(r, "name"),
                    c && c.add(l.name, r.style.color || r.style.strokeColor)
        ...
        onlegendSelected: function(e, t) {
            var n = e.selected;
            for (var r in this.selectedMap) this.selectedMap[r] != n[r] && (t.needRefresh = !0),
            this.selectedMap[r] = n[r];
            return
        },
        ...
        _getLabelText: function(e, t, n, r) {
            var i = this.deepQuery([t, e], "itemStyle." + r + ".label.formatter"); ! i && r == "emphasis" && (i = this.deepQuery([t, e], "itemStyle.normal.label.formatter"));
        ...
        _buildMarkPoint: function(e) {
            ...
            for (var a = 0,
            f = u.data.length; a < f; a++) i = u.data[a],
            o = this.getMarkCoord(e, i),
            u.data[a].x = typeof i.x != "undefined" ? i.x: o[0],
            u.data[a].y = typeof i.y != "undefined" ? i.y: o[1],
            i.type && (i.type == "max" || i.type == "min") && (u.data[a].value = o[3], u.data[a].name = i.name || i.type, u.data[a].symbolSize = u.data[a].symbolSize || c.getTextWidth(o[3], this.getFont()) / 2 + 5);
            ...
            if (this.type == s.CHART_TYPE_FORCE || this.type == s.CHART_TYPE_CHORD) for (var a = 0,
            f = h.length; a < f; a++) this.zr.addShape(h[a])
        },
        _buildMarkLine: function(e) {
            ...
            for (var a = 0,
            f = u.data.length; a < f; a++) i = u.data[a],
            !i.type || i.type != "max" && i.type != "min" && i.type != "average" ? o = [this.getMarkCoord(e, i[0]), this.getMarkCoord(e, i[1])] : (o = this.getMarkCoord(e, i), u.data[a] = [l.clone(i), {}], u.data[a][0].name = i.name || i.type, u.data[a][0].value = o[3], o = o[2], i = [{},
            {}]),
            u.data[a][0].x = typeof i[0].x != "undefined" ? i[0].x: o[0][0],
            u.data[a][0].y = typeof i[0].y != "undefined" ? i[0].y: o[0][1],
            u.data[a][1].x = typeof i[1].x != "undefined" ? i[1].x: o[1][0],
            u.data[a][1].y = typeof i[1].y != "undefined" ? i[1].y: o[1][1];
            ...
            if (this.type == s.CHART_TYPE_FORCE || this.type == s.CHART_TYPE_CHORD) for (var a = 0,
            f = c.length; a < f; a++) this.zr.addShape(c[a])
        },
        _markPoint: function(e, t) {
            ...
            E = u.length; w < E; w++) {
                ...
                i.push(a)
            } else a = this.getLargeMarkPoingShape(e, t),
            a._mark = "largePoint",
            a && i.push(a);
            return i
        },
        ...
        getLargeMarkPoingShape: function(e, t) {
            ...
            symbol = this.deepQuery(c, "symbol") || "circle",
        ...
        addShapeList: function() {
            ...
            if (this.option.animation && !this.option.renderAsImage && n.length < e && !this.motionlessOnce) {
                for (var a = 0,
                f = t.length; a < f; a++) s = this._getAnimationKey(t[a]),
                s.match("undefined") ? this.zr.delShape(t[a].id) : (s += t[a].type, o[s] = t[a]);
                for (var a = 0,
                f = n.length; a < f; a++) s = this._getAnimationKey(n[a]),
                s.match("undefined") ? this.zr.addShape(n[a]) : (s += n[a].type, u[s] = n[a]);
                ...
                this.zr.delShape(t);
                for (var a = 0,
                f = n.length; a < f; a++) this.zr.addShape(n[a])
            }
        },
        ...
        animationMark: function(e, t, n) {
            ...
            var r, i;
            for (var s = 0,
            o = shapeList.length; s < o; s++) {
                if (!shapeList[s]._mark) continue;
                this._animateMod(!1, shapeList[s], e, t)
            }
            this.animationEffect(n)
        },
        animationEffect: function(e) { ! e && this.clearEffectShape(),
            shapeList = e || this.shapeList;
            ...
            var n;
            for (var r = 0,
            i = shapeList.length; r < i; r++) {
                n = shapeList[r];
                if (! (n._mark && n.effect && n.effect.show && a[n._mark])) continue;
                a[n._mark](this.zr, this.effectList, n, t),
                this.effectList[this.effectList.length - 1]._mark = n._mark
            }
        },
        ...
        addMark: function(e, t, n) {
            ...
            if (this.selectedMap[r.name]) {
                ...
                for (var a = u,
                f = this.shapeList.length; a < f; a++) this.zr.addShape(this.shapeList[a]);
                this.zr.refresh(),
        ...
        delMark: function(e, t, n) {
            ...
            if (this.selectedMap[r.name]) {
                ...
                u = 2;
                while (u--) for (var a = 0,
                f = s[u].length; a < f; a++) if (s[u][a]._mark == n && o.get(s[u][a], "seriesIndex") == e && o.get(s[u][a], "name") == t) {
...
define("echarts/chart/island", ["require", "../component/base", "./base", "zrender/shape/Circle", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/event", "zrender/tool/color", "../util/accMath", "../chart"],
function(e) {
    ...
    return a.prototype = {
        ...
        resize: function() {
            ...
            this._zrHeight = t;
            for (var i = 0,
            s = this.shapeList.length; i < s; i++) this.zr.modShape(this.shapeList[i].id, {
                style: {
        ...
        del: function(e) {
            ...
            var t = [];
            for (var n = 0,
            r = this.shapeList.length; n < r; n++) this.shapeList[n].id != e.id && t.push(this.shapeList[n]);
            this.shapeList = t
        },
        ondrop: function(e, t) {
            if (!this.isDrop || !e.target) return;
    ...
    return i.prototype = {
        ...
        _optionToContent: function() {
            ...
            if (this.option.xAxis) {
                ...
                for (e = 0, i = u.length; e < i; e++) if ((u[e].type || "category") == "category") {
                    o = [];
                    for (t = 0, r = u[e].data.length; t < r; t++) s = u[e].data[t],
                    o.push(typeof s.value != "undefined" ? s.value: s);
                    a += o.join(", ") + "\n\n"
                }
            }
            ...
            for (e = 0, i = f.length; e < i; e++) {
                o = [];
                for (t = 0, r = f[e].data.length; t < r; t++) s = f[e].data[t],
                f[e].type == n.CHART_TYPE_PIE || f[e].type == n.CHART_TYPE_MAP ? l = (s.name || "-") + ":": l = "",
                f[e].type == n.CHART_TYPE_SCATTER && (s = typeof s.value != "undefined" ? s.value: s, s = s.join(", ")),
                o.push(l + (typeof s.value != "undefined" ? s.value: s));
                a += (f[e].name || "-") + " : \n",
        ...
        _save: function() {
            ...
            if (typeof t != "function") {
                ...
                var r = [];
                for (var i = 0,
                s = e.length; i < s; i++) e[i] = this._trim(e[i]),
                e[i] !== "" && r.push(e[i]);
        ...
        _contentToOption: function(e) {
            ...
            if (this.option.xAxis) {
                ...
                for (t = 0, s = u.length; t < s; t++) if ((u[t].type || "category") == "category") {
                    f = e[a].split(",");
                    for (r = 0, i = u[t].data.length; r < i; r++) l = this._trim(f[r] || ""),
                    o = u[t].data[r],
                    typeof u[t].data[r].value != "undefined" ? u[t].data[r].value = l: u[t].data[r] = l;
                    a++
                }
            }
            if (this.option.yAxis) {
            ...
            for (t = 0, s = c.length; t < s; t++) {
                a++;
                if (c[t].type == n.CHART_TYPE_SCATTER) for (var r = 0,
                i = c[t].data.length; r < i; r++) f = e[a],
                l = f.replace(" ", "").split(","),
                typeof c[t].data[r].value != "undefined" ? c[t].data[r].value = l: c[t].data[r] = l,
                a++;
                else {
                    f = e[a].split(",");
                    for (var r = 0,
                    i = c[t].data.length; r < i; r++) l = (f[r] || "").replace(/.*:/, ""),
                    l = this._trim(l),
                    l = l != "-" && l !== "" ? l - 0 : "-",
                    typeof c[t].data[r].value != "undefined" ? c[t].data[r].value = l: c[t].data[r] = l;
                    a++
...
function(e) {
    ...
    return h.prototype = {
        ...
        _buildShape: function() {
            ...
            case "magicType":
                for (var i = 0,
                s = t[r].type.length; i < s; i++) t[r].title[t[r].type[i] + "Chart"] = t[r].title[t[r].type[i]],
                n.push({
                    key: r,
            ...
            if (n.length > 0) {
                var o, r;
                for (var i = 0,
                s = n.length; i < s; i++) o = n[i].name,
                r = n[i].key,
                this._iconList.push(o),
                this._featureTitle[o] = t[r].title[o] || t[r].title,
                t[r].icon && (this._featureIcon[o] = t[r].icon[o] || t[r].icon),
                t[r].color && (this._featureColor[o] = t[r].color[o] || t[r].color);
                this._itemGroupLocation = this._getItemGroupLocation(),
                this._buildBackground(),
                this._buildItem();
                for (var i = 0,
                s = this.shapeList.length; i < s; i++) this.zr.addShape(this.shapeList[i]);
        ...
        getMagicOption: function() {
            ...
            if (this._magicType[o.CHART_TYPE_LINE] || this._magicType[o.CHART_TYPE_BAR]) {
                ...
                for (var n = 0,
                r = this.option.series.length; n < r; n++) this._magicMap[this.option.series[n].type] && (this.option.series[n].type = this._magicType[o.CHART_TYPE_LINE] ? o.CHART_TYPE_LINE: o.CHART_TYPE_BAR, this.option.series[n].itemStyle = u.clone(this.option.series[n].__itemStyle), e = this.option.xAxis instanceof Array ? this.option.xAxis[this.option.series[n].xAxisIndex || 0] : this.option.xAxis, e && (e.type || "category") == "category" && (e.boundaryGap = t ? !0 : e.__boundaryGap), e = this.option.yAxis instanceof Array ? this.option.yAxis[this.option.series[n].yAxisIndex || 0] : this.option.yAxis, e && e.type == "category" && (e.boundaryGap = t ? !0 : e.__boundaryGap))
            }
            if (this._magicType[l] || this._magicType[c]) for (var n = 0,
            r = this.option.series.length; n < r; n++) this._magicType[l] ? this.option.series[n].stack = "_ECHARTS_STACK_KENER_2014_": this._magicType[c] && (this.option.series[n].stack = null);
            return this.option
        },
        silence: function(e) {
            this._isSilence = e
...
function(e) {
    ...
    return a.prototype = {
        ...
        _buildShape: function() {
            ...
            this._buildItem();
            for (var e = 0,
            t = this.shapeList.length; e < t; e++) this.zr.addShape(this.shapeList[e])
        },
        _buildItem: function() {
            ...
            t && (d.hoverable = !0, d.clickable = !0, d.onclick = function() { ! r || r != "self" ? window.open(t) : window.location = t
            });
            var v = {
                zlevel: this._zlevelBase,
                style: {
            ...
            s && (v.hoverable = !0, v.clickable = !0, v.onclick = function() { ! o || o != "self" ? window.open(s) : window.location = s
            });
...
function(e) {
    ...
    return d.prototype = {
        ...
        _findAxisTrigger: function() {
            ...
            t, n;
            for (var r = 0,
            i = e.length; r < i; r++) if (this.deepQuery([e[r], this.option], "tooltip.trigger") == "axis") {
                t = e[r].xAxisIndex || 0,
                n = e[r].yAxisIndex || 0;
        ...
        _showAxisTrigger: function(e, t, n) { ! this._event.connectTrigger && this.messageCenter.dispatch(o.EVENT.TOOLTIP_IN_GRID, this._event, null, this.myChart);
            ...
            } else a = f.getX(this._event),
            l = f.getY(this._event),
            this._styleAxisPointer(r, this.component.grid.getX(), l, this.component.grid.getXend(), l, 0, a, l),
            n >= 0 ? this._showItemTrigger() : (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), this._tDom.style.display = "none");
            if (i.length > 0) {
                var g;
                if (typeof c == "function") {
                    var y = [];
                    for (var v = 0,
                    m = i.length; v < m; v++) g = i[v].data[n],
                    g = typeof g != "undefined" ? typeof g.value != "undefined" ? g.value: g: "-",
                    y.push([i[v].name || "", u.getNameByIndex(n), g]);
                    this._curTicket = "axis:" + n,
                    this._tDom.innerHTML = c(y, this._curTicket, this._setContent)
                } else if (typeof c == "string") {
                    this._curTicket = NaN,
                    c = c.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}");
                    for (var v = 0,
                    m = i.length; v < m; v++) c = c.replace("{a" + v + "}", this._encodeHTML(i[v].name || "")),
                    c = c.replace("{b" + v + "}", this._encodeHTML(u.getNameByIndex(n))),
                    g = i[v].data[n],
                    g = typeof g != "undefined" ? typeof g.value != "undefined" ? g.value: g: "-",
                    c = c.replace("{c" + v + "}", g instanceof Array ? g: this.numAddCommas(g));
                    this._tDom.innerHTML = c
                } else {
                    this._curTicket = NaN,
                    c = this._encodeHTML(u.getNameByIndex(n));
                    for (var v = 0,
                    m = i.length; v < m; v++) c += "<br/>" + this._encodeHTML(i[v].name || "") + " : ",
                    g = i[v].data[n],
                    g = typeof g != "undefined" ? typeof g.value != "undefined" ? g.value: g: "-",
                    c += g instanceof Array ? g: this.numAddCommas(g);
                    this._tDom.innerHTML = c
                }
        ...
        _showPolarTrigger: function(e, t) {
            ...
            if (r.length > 0) {
                ...
                if (typeof i == "function") this._curTicket = "axis:" + t,
                this._tDom.innerHTML = i(d, this._curTicket, this._setContent);
                else if (typeof i == "string") {
                    i = i.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{d}", "{d0}");
                    for (var l = 0,
                    c = d.length; l < c; l++) i = i.replace("{a" + l + "}", this._encodeHTML(d[l][0])),
                    i = i.replace("{b" + l + "}", this._encodeHTML(d[l][1])),
                    i = i.replace("{c" + l + "}", this.numAddCommas(d[l][2])),
                    i = i.replace("{d" + l + "}", this._encodeHTML(d[l][3]));
                    this._tDom.innerHTML = i
                } else {
                    i = this._encodeHTML(d[0][1]) + "<br/>" + this._encodeHTML(d[0][3]) + " : " + this.numAddCommas(d[0][2]);
                    for (var l = 1,
                    c = d.length; l < c; l++) i += "<br/>" + this._encodeHTML(d[l][1]) + "<br/>",
                    i += this._encodeHTML(d[l][3]) + " : " + this.numAddCommas(d[l][2]);
                    this._tDom.innerHTML = i
                }
        ...
        _showItemTrigger: function() {
            ...
            if (typeof a == "function") this._curTicket = (e.name || "") + ":" + u.get(this._curTarget, "dataIndex"),
            this._tDom.innerHTML = a([e.name || "", n, r, i, s], this._curTicket, this._setContent);
            else if (typeof a == "string") this._curTicket = NaN,
            a = a.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"),
            a = a.replace("{a0}", this._encodeHTML(e.name || "")).replace("{b0}", this._encodeHTML(n)).replace("{c0}", r instanceof Array ? r: this.numAddCommas(r)),
            a = a.replace("{d}", "{d0}").replace("{d0}", i || ""),
            a = a.replace("{e}", "{e0}").replace("{e0}", u.get(this._curTarget, "special2") || ""),
            this._tDom.innerHTML = a;
                ...
                } else if (e.type == o.CHART_TYPE_CHORD) if (typeof s == "undefined") this._tDom.innerHTML = this._encodeHTML(n) + " (" + this.numAddCommas(r) + ")";
                else {
            ...
            if (!this._axisLineShape.invisible || !this._axisShadowShape.invisible) this._axisLineShape.invisible = !0,
        ...
        _styleAxisPointer: function(e, t, n, r, i, s, o, u) {
            if (e.length > 0) {
                ...
                for (var p in h) h[p].color = l[p + "Style"].color,
                h[p].width = l[p + "Style"].width,
                h[p].type = l[p + "Style"].type;
                for (var d = 0,
                v = e.length; d < v; d++) this.deepQuery([e[d], this.option], "tooltip.trigger") == "axis" && (a = e[d], f = this.query(a, "tooltip.axisPointer.type"), c = f || c, f && (h[f].color = this.query(a, "tooltip.axisPointer." + f + "Style.color") || h[f].color, h[f].width = this.query(a, "tooltip.axisPointer." + f + "Style.width") || h[f].width, h[f].type = this.query(a, "tooltip.axisPointer." + f + "Style.type") || h[f].type));
        ...
        __onmousemove: function(e) {
            ...
            n = f.getX(e.event),
            r = f.getY(e.event);
            if (!t) this._curTarget = !1,
            this._event = e.event,
            this._event._target = this._event.target || this._event.toElement,
            this._event.zrenderX = n,
            this._event.zrenderY = r,
            this._needAxisTrigger && this.component.grid && l.isInside(s, this.component.grid.getArea(), n, r) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : this._needAxisTrigger && this.component.polar && this.component.polar.isInside([n, r]) != -1 ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : (!this._event.connectTrigger && this.messageCenter.dispatch(o.EVENT.TOOLTIP_OUT_GRID, this._event, null, this.myChart), this._hidingTicket = setTimeout(this._hide, this._hideDelay));
            else {
                this._curTarget = t,
                this._event = e.event,
                this._event._target = this._event.target || this._event.toElement,
                ...
                if (this._needAxisTrigger && this.component.polar && (i = this.component.polar.isInside([n, r])) != -1) {
                    ...
                    for (var a = 0,
                    c = u.length; a < c; a++) if (u[a].polarIndex == i && this.deepQuery([u[a], this.option], "tooltip.trigger") == "axis") {
        ...
        ontooltipHover: function(e, t) {
            if (!this._lastTipShape || this._lastTipShape && this._lastTipShape.dataIndex != e.dataIndex) {
                ...
                for (var n = 0,
                r = t.length; n < r; n++) t[n].zlevel = this._zlevelBase,
                t[n].style = p.prototype.getHighlightStyle(t[n].style, t[n].highlightStyle),
                t[n].draggable = !1,
                t[n].hoverable = !1,
                t[n].clickable = !1,
                t[n].ondragend = null,
        ...
        showTip: function(e) {
            ...
            if (typeof e.seriesIndex != "undefined") t = e.seriesIndex;
                ...
                var r = e.seriesName;
                for (var i = 0,
                s = n.length; i < s; i++) if (n[i].name == r) {
                    t = i;
                    break
                }
            }
            ...
            if (c) {
                ...
                case o.CHART_TYPE_SCATTER:
                    var h = e.dataIndex;
                    for (var i = 0,
                    s = g.length; i < s; i++) if (u.get(g[i], "seriesIndex") == t && u.get(g[i], "dataIndex") == h) {
                        this._curTarget = g[i],
                        y = g[i].style.x,
                ...
                case o.CHART_TYPE_RADAR:
                    var h = e.dataIndex;
                    for (var i = 0,
                    s = g.length; i < s; i++) if (g[i].type == "polygon" && u.get(g[i], "seriesIndex") == t && u.get(g[i], "dataIndex") == h) {
                        this._curTarget = g[i];
                ...
                case o.CHART_TYPE_PIE:
                    var w = e.name;
                    for (var i = 0,
                    s = g.length; i < s; i++) if (g[i].type == "sector" && u.get(g[i], "seriesIndex") == t && u.get(g[i], "name") == w) {
                        this._curTarget = g[i];
                ...
                case o.CHART_TYPE_MAP:
                    ...
                    x = f.mapType;
                    for (var i = 0,
                    s = g.length; i < s; i++) if (g[i].type == "text" && g[i]._mapType == x && g[i].style._name == w) {
                        this._curTarget = g[i],
                ...
                case o.CHART_TYPE_CHORD:
                    var w = e.name;
                    for (var i = 0,
                    s = g.length; i < s; i++) if (g[i].type == "sector" && u.get(g[i], "name") == w) {
                        this._curTarget = g[i];
                        var E = this._curTarget.style,
                        S = (E.startAngle + E.endAngle) / 2 * Math.PI / 180;
                ...
                case o.CHART_TYPE_FORCE:
                    var w = e.name;
                    for (var i = 0,
                    s = g.length; i < s; i++) if (g[i].type == "circle" && u.get(g[i], "name") == w) {
                        this._curTarget = g[i],
        ...
        refresh: function(e) {
            ...
            if (e) {
                ...
                for (var n = 0,
                r = t.length; n < r; n++) if (this.query(t[n], "tooltip.trigger") == "axis") {
        ...
        dispose: function() {
            ...
            clearTimeout(this._hidingTicket),
            clearTimeout(this._showingTicket),
            this.zr.un(a.EVENT.MOUSEMOVE, self._onmousemove),
            this.zr.un(a.EVENT.GLOBALOUT, self._onglobalout),
...
define("zrender/shape/Sector", ["require", "../tool/math", "./Base", "./Ring", "./Polygon", "../tool/util"],
function(e) {
    function r(e) {
        n.call(this, e)
    }
    ...
    return r.prototype = {
        ...
        getRect: function(n) {
            ...
            u = n.startAngle,
            a = n.endAngle;
            if (Math.abs(a - u) >= 360) return n.__rect = e("./Ring").prototype.getRect(n),
            n.__rect;
            u = (720 + u) % 360,
            a = (720 + a) % 360,
            a <= u && (a += 360);
    ...
    l.prototype = {
        ...
        _buildItem: function() {
            ...
            for (var E = 0; E < t; E++) {
                ...
                w = this.getColor(r),
                this.legendOption.orient == "horizontal" ? p - v < 200 && g + 5 + f.getTextWidth(r, h) + (E == t - 1 || e[E + 1] === "" ? 0 : b) >= p - v && (v = this._itemGroupLocation.x, m += y + b) : d - m < 200 && y + (E == t - 1 || e[E + 1] === "" ? 0 : b) >= d - m && (this.legendOption.x == "right" ? v -= this._itemGroupLocation.maxWidth + b: v += this._itemGroupLocation.maxWidth + b, m = this._itemGroupLocation.y),
                o = this._getItemShapeByType(v, m, g, y, this._selectedMap[r] ? w: "#ccc", i, w),
                o._name = r,
                o = new s(o),
                u = {
                    zlevel: this._zlevelBase,
                ...
                this.legendOption.orient == "vertical" && this.legendOption.x == "right" && (u.style.x -= g + 10, u.style.textAlign = "right"),
                u._name = r,
                u = new n(u),
                ...
                this.shapeList.push(u),
                this.legendOption.orient == "horizontal" ? v += g + 5 + f.getTextWidth(r, h) + b: m += y + b
            }
        ...
        _getItemGroupLocation: function() {
            ...
            if (this.legendOption.orient == "horizontal") {
                ...
                for (var m = 0; m < t; m++) {
                    ...
                    dataTextStyle = a.merge(e[m].textStyle || {},
                    s),
                    d += r + f.getTextWidth(this._getName(e[m]), e[m].textStyle ? this.getFont(a.merge(e[m].textStyle || {},
                    s)) : o) + n
                }
                l = Math.max(l, i),
                d -= n,
                ...
                for (var m = 0; m < t; m++) v = Math.max(v, f.getTextWidth(this._getName(e[m]), e[m].textStyle ? this.getFont(a.merge(e[m].textStyle || {},
                s)) : o));
                v += r,
                u = v;
                for (var m = 0; m < t; m++) {
        ...
        _getSomethingByName: function(e) {
            ...
            i = t.length; r < i; r++) {
                ...
                if (t[r].type == u.CHART_TYPE_PIE || t[r].type == u.CHART_TYPE_RADAR || t[r].type == u.CHART_TYPE_CHORD || t[r].type == u.CHART_TYPE_FORCE || t[r].type == u.CHART_TYPE_FUNNEL) {
                    ...
                    for (var s = 0,
                    o = n.length; s < o; s++) if (n[s].name == e) return {
                        type: t[r].type,
                        series: t[r],
                        seriesIndex: r,
                        data: n[s],
        ...
        getRelatedAmount: function(e) {
            ...
            s = n.length; i < s; i++) {
                ...
                if (n[i].type == u.CHART_TYPE_PIE || n[i].type == u.CHART_TYPE_RADAR || n[i].type == u.CHART_TYPE_CHORD || n[i].type == u.CHART_TYPE_FORCE || n[i].type == u.CHART_TYPE_FUNNEL) {
                    ...
                    for (var o = 0,
                    a = r.length; o < a; o++) r[o].name == e && r[o].value != "-" && t++
                }
            }
            return t
        },
        ...
        add: function(e, t) {
            ...
            for (var r = 0,
            i = n.length; r < i; r++) if (this._getName(n[r]) == e) return;
        ...
        del: function(e) {
            var t = this.legendOption.data;
            for (var n = 0,
            r = t.length; n < r; n++) if (this._getName(t[n]) == e) return this.legendOption.data.splice(n, 1)
        },
        ...
        setItemShape: function(e, t) {
            var n;
            for (var r = 0,
            i = this.shapeList.length; r < i; r++) n = this.shapeList[r],
            n._name == e && n.type != "text" && (this._selectedMap[e] || (t.style.color = "#ccc", t.style.strokeColor = "#ccc"), this.zr.modShape(n.id, t))
        },
        ...
        onlegendSelected: function(e, t) {
            var n = e.selected;
            for (var r in n) this._selectedMap[r] != n[r] && (t.needRefresh = !0),
            this._selectedMap[r] = n[r];
            return
        }
    };
    var c = {
...
function(e) {
    ...
    return o.prototype = {
        ...
        _updateTextTransform: function(e, t) {
            ...
            if (t[0] !== 0) {
                var r = t[1] || 0,
                i = t[2] || 0; (r || i) && s.translate(n, n, [ - r, -i]),
                s.rotate(n, n, t[0]),
...
function(e) {
    function f(e, n, r, i, o) {
        ...
        u._setCurrentOption = function() {
            ...
            u.myChart.setOption(t, e.notMerge),
            u.messageCenter.dispatch(s.EVENT.TIMELINE_CHANGED, null, {
        ...
        u._onFrame = function() {
            u._setCurrentOption(),
            u._syncHandleShape(),
            u.timelineOption.autoPlay && (u.playTicket = setTimeout(function() {
                u.currentIndex += 1;
                if (!u.timelineOption.loop && u.currentIndex >= u.timelineOption.data.length) {
                    u.currentIndex = u.timelineOption.data.length - 1,
                    u.stop();
                    return
                }
                u._onFrame()
    ...
    function l(e, t) {
        ...
        u = t.height - n,
        a = t.symbol;
        if (a == "last") e.moveTo(i + o - 2, s + u / 3),
        e.lineTo(i + o - 2, s),
        e.lineTo(i + 2, s + u / 2),
        e.lineTo(i + o - 2, s + u),
        e.lineTo(i + o - 2, s + u / 3 * 2),
        e.moveTo(i, s),
        e.lineTo(i, s);
        else if (a == "next") e.moveTo(i + 2, s + u / 3),
        e.lineTo(i + 2, s),
        e.lineTo(i + o - 2, s + u / 2),
        e.lineTo(i + 2, s + u),
        e.lineTo(i + 2, s + u / 3 * 2),
        e.moveTo(i, s),
        e.lineTo(i, s);
        else if (a == "play") if (t.status == "stop") e.moveTo(i + 2, s),
        e.lineTo(i + o - 2, s + u / 2),
        e.lineTo(i + 2, s + u),
        e.lineTo(i + 2, s);
        else {
    ...
    return f.prototype = {
        ...
        _buildShape: function() {
            ...
            if (this.timelineOption.label.show) {
                ...
                for (var t = 0,
                n = this._chainPoint.length; t < n; t += e) this._chainPoint[t].showLabel = !0
            }
            this._buildChain(),
            this._buildHandle();
            for (var t = 0,
            r = this.shapeList.length; t < r; t++) this.zr.addShape(this.shapeList[t])
        },
        ...
        _getReformedLabel: function(e) {
            ...
            return r && (typeof r == "function" ? n = r(n) : typeof r == "string" && (n = r.replace("{value}", n))),
            n
        },
        ...
        _getChainPoint: function() {
            ...
            if (h > 1) {
                ...
                v = v > 50 ? 50 : v < 20 ? 5 : v,
                c -= v * 2;
                if (e.type == "number") for (var m = 0; m < h; m++) d.push(f + v + c / (h - 1) * m);
                else {
            ...
            E,
            S;
            for (var m = 0; m < h; m++) f = d[m],
            y = a[m].symbol && a[m].symbol.toLowerCase() || t,
            y.match("empty") ? (y = y.replace("empty", ""), w = !0) : w = !1,
            y.match("star") && (b = y.replace("star", "") - 0 || 5, y = "star"),
            u = a[m].textStyle ? o.merge(a[m].textStyle || {},
            i) : i,
            E = u.align || "center",
            r ? (E = r > 0 ? "right": "left", S = [r * Math.PI / 180, f, l - 5]) : S = !1,
            g.push({
                x: f,
                n: b,
                isEmpty: w,
        ...
        _buildBackground: function() {
            ...
            i = this._location.height; (e.borderWidth !== 0 || e.backgroundColor.replace(/\s/g, "") != "rgba(0,0,0,0)") && this.shapeList.push(new n({
                zlevel: this._zlevelBase,
                hoverable: !1,
                style: {
        ...
        ondragend: function(e, t) {
            if (!this.isDragend || !e.target) return; ! this.timelineOption.realtime && this._setCurrentOption(),
            t.dragOut = !0,
            t.dragIn = !0,
            t.needRefresh = !1,
            this.isDragend = !1,
        ...
        setTheme: function(e) {
            ...
            this.timelineOption.label.textStyle = o.merge(this.timelineOption.label.textStyle || {},
            this.ecTheme.textStyle),
            this.timelineOption.checkpointStyle.label.textStyle = o.merge(this.timelineOption.checkpointStyle.label.textStyle || {},
            this.ecTheme.textStyle),
...
function(e) {
    ...
    s.prototype._start = function(e, t) {
        ...
        if (s.progress != null) {
            e(u),
            f.highlightStyle.width = _adjust(s.progress, [0, 1]) * s.effectOption.width,
            e(f),
            e(o),
            t();
            return
    ...
    s.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            ...
            for (var n = 0; n < f; n++) {
                ...
                r.y - h[n].animationY + r.r <= 0 && (h[n].highlightStyle.y = this.canvasHeight + r.r, h[n].highlightStyle.x = Math.ceil(Math.random() * this.canvasWidth)),
    ...
    s.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            ...
            for (var n = 0; n < f; n++) {
                ...
                r.xStart >= this.canvasWidth && (c[n].len = Math.ceil(Math.random() * 400), r.xStart = -400, r.xEnd = -400 + c[n].len, r.yStart = Math.ceil(Math.random() * this.canvasHeight), r.yEnd = r.yStart),
...
function(e) {
    ...
    o.prototype._start = function(e, t) {
        ...
        if (o.progress != null) {
            e(l),
            x = _adjust(o.progress, [0, 1]).toFixed(2) * 100 / 5,
            g.highlightStyle.text = x * 5 + "%",
            e(g);
            for (var S = 0; S < 20; S++) y[S].highlightStyle.color = S < x ? y[S]._color: m,
            e(y[S]);
            e(f),
            t();
            return
        ...
        return setInterval(function() {
            ...
            x += x >= 20 ? -20 : 1,
            e(g);
            for (var n = 0; n < 20; n++) y[n].highlightStyle.color = n < x ? y[n]._color: m,
            e(y[n]);
            e(f),
            t()
        },
...
define("zrender/loadingEffect/Spin", ["require", "./Base", "../tool/util", "../tool/color", "../shape/Sector"],
function(e) {
    function s(e) {
        t.call(this, e)
    }
    ...
    s.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            e(a),
            y[0] -= .3;
            for (var n = 0; n < f; n++) v[n].rotation = y,
            e(v[n]);
            e(u),
            t()
        },
...
define("zrender/loadingEffect/Whirling", ["require", "./Base", "../tool/util", "../shape/Ring", "../shape/Droplet", "../shape/Circle"],
function(e) {
    function o(e) {
        t.call(this, e)
    }
...
function(e) {
    ...
    r.init = function(t, n) {
        var i = e("zrender"); (i.version || "1.0.3").replace(".", "") - 0 < r.dependencies.zrender.replace(".", "") - 0 && console.error("ZRender " + (i.version || "1.0.3-") + " is too old for ECharts " + r.version + ". Current version need ZRender " + r.dependencies.zrender + "+"),
        t = t instanceof Array ? t[0] : t;
        var f = t.getAttribute(u);
        return f || (f = s++, t.setAttribute(u, f)),
        o[f] && o[f].dispose(),
        o[f] = new a(t),
        o[f].id = f,
        o[f].setTheme(n),
    ...
    return a.prototype = {
        _init: function() {
            ...
            i.Dispatcher.call(this._messageCenter),
            i.Dispatcher.call(this._messageCenterOutSide),
            this._messageCenter._dispatch = this._messageCenter.dispatch,
            this._messageCenter.dispatch = function(e, t, r, i) {
                n._messageCenter._dispatch(e, t, r, i),
            ...
            a = l.length; u < a; u++) {
                var c = l[u],
                h = f[c];
                o[h] = "_on" + c.toLowerCase(),
                r.on(h, this._onzrevent)
            }
            this.chart = {},
            this.component = {};
            var p = e("./chart/island");
            this._island = new p(this._themeConfig, this._messageCenter, r, {},
            this),
            this.chart.island = this._island;
            var d = e("./component/toolbox");
            this._toolbox = new d(this._themeConfig, this._messageCenter, r, {},
            this),
            this.component.toolbox = this._toolbox;
            var v = e("./component");
            v.define("title", e("./component/title")),
            v.define("tooltip", e("./component/tooltip")),
            v.define("legend", e("./component/legend"))
        },
        ...
        _ondrop: function(e) {
            c(this, "ondrop", e, this._status),
            this._island.ondrop(e, this._status)
        },
        _ondragend: function(e) {
            c(this, "ondragend", e, this._status),
        ...
        _render: function(n) {
            ...
            if (r) if (!i && r.indexOf("rgba") != -1) {
                var s = r.split(",");
                this.dom.style.filter = "alpha(opacity=" + s[3].substring(0, s[3].lastIndexOf(")")) * 100 + ")",
                s.length = 3,
                s[0] = s[0].replace("a", ""),
                this.dom.style.backgroundColor = s.join(",") + ")"
            } else this.dom.style.backgroundColor = r;
            this._zr.clearAnimation(),
            this._chartList = [];
            var o = e("./chart"),
            u = e("./component");
            if (n.xAxis || n.yAxis) n.grid = n.grid || {},
            ...
            c;
            for (var h = 0,
            p = a.length; h < p; h++) l = a[h],
            c = this.component[l],
            n[l] ? (c ? c.refresh && c.refresh(n) : (f = u.get(/^[xy]Axis$/.test(l) ? "axis": l), c = new f(this._themeConfig, this._messageCenter, this._zr, n, this, l), this.component[l] = c), this._chartList.push(c)) : c && (c.dispose(), this.component[l] = null, delete this.component[l]);
            var d, v, m, g = {};
            for (var h = 0,
            p = n.series.length; h < p; h++) {
                v = n.series[h].type;
                if (!v) {
            ...
            n.renderAsImage && i ? (b ? b.src = this.getDataURL(n.renderAsImage) : (b = this.getImage(n.renderAsImage), b.id = y, b.style.position = "absolute", b.style.left = 0, b.style.top = 0, this.dom.firstChild.appendChild(b)), this.un(), this._zr.un(), this._disposeChartList(), this._zr.clear()) : b && b.parentNode.removeChild(b),
            b = null,
            this._option = n
        },
        restore: function() {
        ...
        refresh: function(e) {
            this._clearEffect(),
            e = e || {};
            var t = e.option; ! this._refreshInside && t && (t = this.getOption(), n.merge(t, e.option, !0), n.merge(this._optionRestore, e.option, !0), this._toolbox.reset(t)),
            this._island.refresh(t),
            this._toolbox.refresh(t),
            this._zr.clearAnimation();
            for (var r = 0,
            i = this._chartList.length; r < i; r++) this._chartList[r].refresh && this._chartList[r].refresh(t);
            this.component.grid && this.component.grid.refixAxisShape(this.component),
            this._zr.refresh()
        },
        ...
        _setOption: function(e, t) { ! t && this._option ? this._option = n.merge(this.getOption(), n.clone(e), !0) : this._option = n.clone(e),
        ...
        addData: function(e, r, i, s, o) {
                ...
                if (h) {
                    ...
                    if (o != null) {
                        ...
                        if (h.type == t.CHART_TYPE_PIE && (g = f.legend) && (y = g.data)) {
                            ...
                            if (typeof f.xAxis[x].type == "undefined" || f.xAxis[x].type == "category") E = f.xAxis[x].data,
                            S = a.xAxis[x].data,
                            E[p](o),
                            S[p](o),
                            s || (E[d](), S[d]());
            ...
            for (var l = 0,
            c = T.length; l < c; l++) a.addDataAnimation && T[l].addDataAnimation && T[l].addDataAnimation(u);
            ...
            return setTimeout(function() {
                ...
                for (var e = 0,
                n = T.length; e < n; e++) T[e].motionlessOnce = a.addDataAnimation && T[e].addDataAnimation;
        ...
        getDataURL: function(e) {
            ...
            return s && s.replace(" ", "") == "rgba(0,0,0,0)" && (s = "#fff"),
            this._zr.toDataURL("image/" + e, s)
        },
        getImage: function(e) {
        ...
        getConnectedDataURL: function(t) {
            ...
            o = r.self.right,
            u = r.self.bottom;
            for (var a in this._connected) n = this._connected[a].getDom(),
            r[a] = {
        ...
        on: function(e, t) {
            return this._messageCenterOutSide.bind(e, t),
            this
        },
        un: function(e, t) {
        ...
        connect: function(e) {
            ...
            n = e.length; t < n; t++) this._connected[e[t].id] = e[t];
        ...
        disConnect: function(e) {
            ...
            if (e instanceof Array) for (var t = 0,
            n = e.length; t < n; t++) delete this._connected[e[t].id];
            else delete this._connected[e.id];
            for (var r in this._connected) return r,
            this;
        ...
        setTheme: function(r) {
            ...
            i || (this._themeConfig.textStyle.fontFamily = this._themeConfig.textStyle.fontFamily2),
        ...
        resize: function() {
            ...
            return function() {
                e._clearEffect(),
                e._zr.resize();
                if (e._option.renderAsImage && i) return e._render(e._option),
                e;
                ...
                for (var n = 0,
                r = e._chartList.length; n < r; n++) e._chartList[n].resize && e._chartList[n].resize();
...
define("echarts/util/shape/GaugePointer", ["require", "zrender/shape/Base", "zrender/tool/util", "./normalIsCover"],
function(e) {
    function r(e) {
        t.call(this, e)
    }
...
define("echarts/chart/gauge", ["require", "../component/base", "./base", "../util/shape/GaugePointer", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "zrender/shape/Circle", "zrender/shape/Sector", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/math", "zrender/tool/color", "../chart"],
function(e) {
    ...
    return d.prototype = {
        ...
        _buildShape: function() {
            ...
            this._paramsMap = {};
            for (var t = 0,
            n = e.length; t < n; t++) e[t].type == f.CHART_TYPE_GAUGE && (e[t] = this.reformOption(e[t]), this._buildSingleGauge(t), this.buildMark(t));
            this.addShapeList()
        },
        ...
        _buildAxisLine: function(e) {
            ...
            g;
            for (var y = 0,
            b = a.length; y < b; y++) g = o - u * (a[y][0] - n) / r,
            d = this._getSector(s, p, h, g, m, a[y][1], f),
            m = g,
            d._animationAdd = "r",
            l.set(d, "seriesIndex", e),
            l.set(d, "dataIndex", y),
        ...
        _buildAxisLabel: function(e) {
            ...
            g,
            y;
            for (var b = 0; b <= n; b++) y = r + s / n * b,
            v = c - h / n * b,
            m = Math.sin(v * Math.PI / 180),
            g = Math.cos(v * Math.PI / 180),
            v = (v + 360) % 360,
            this.shapeList.push(new i({
                zlevel: this._zlevelBase + 1,
                hoverable: !1,
        ...
        _colorMap: function(e) {
            ...
            var s = [];
            for (var o = 0,
            u = i.length; o < u; o++) s.push([i[o][0] * r + n, i[o][1]]);
        ...
        _getColor: function(e, t) {
            ...
            for (var r = 0,
            i = n.length; r < i; r++) if (n[r][0] >= t) return n[r][1];
    ...
    c.inherits(d, n),
    c.inherits(d, t),
    e("../chart").define("gauge", d),
    d
}),
define("echarts/chart/funnel", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "zrender/shape/Polygon", "zrender/shape/Circle", "zrender/shape/Sector", "../config", "../util/ecData", "../util/number", "zrender/tool/util", "zrender/tool/math", "zrender/tool/color", "zrender/tool/area", "../chart"],
function(e) {
    function m(e, r, i, s, o) {
        t.call(this, e, r, i, s, o),
        n.call(this),
    ...
    return m.prototype = {
        ...
        _buildShape: function() {
            ...
            var n;
            for (var r = 0,
            i = e.length; r < i; r++) if (e[r].type == f.CHART_TYPE_FUNNEL) {
        ...
        _buildSingleFunnel: function(e) {
            ...
            u = [];
            for (var a = 0,
            f = r.length; a < f; a++) s = r[a].name,
            t ? this.selectedMap[s] = t.isSelected(s) : this.selectedMap[s] = !0,
            this.selectedMap[s] && !isNaN(r[a].value) && (u.push(r[a]), o++);
            if (o === 0) return;
            ...
            for (var a = 0,
            f = u.length; a < f; a++) s = u[a].name,
            this.selectedMap[s] && !isNaN(u[a].value) && (d = a <= f - 2 ? this._getItemWidth(e, u[a + g].value) : n.sort == "descending" ? c.parsePercent(n.minSize, i.width) : c.parsePercent(n.maxSize, i.width), this._buildItem(e, u[a]._index, t ? t.getColor(s) : this.zr.getColor(u[a]._index), y - m / 2, v, m, d, p), v += p + h, m = d, b.unshift([y - m / 2 - 10, v]), b.push([y + m / 2 + 10, v]));
        ...
        _buildFunnelCase: function(e) {
            ...
            if (this.deepQuery([t, this.option], "calculable")) {
                ...
                return l.pack(a, t, e, undefined, -1),
        ...
        _buildItem: function(e, t, n, r, i, s, o, u) {
            ...
            l.pack(h, a[e], e, a[e].data[t], t, a[e].data[t].name),
            this.shapeList.push(h);
            var p = this.getLabel(e, t, n, r, i, s, o, u);
            l.pack(p, a[e], e, a[e].data[t], t, a[e].data[t].name),
            this.shapeList.push(p),
            this._needLabel(f, c, !1) || (p.invisible = !0);
            var d = this.getLabelLine(e, t, n, r, i, s, o, u);
            this.shapeList.push(d),
            this._needLabelLine(f, c, !1) || (d.invisible = !0);
            var v = [],
            m = [];
            this._needLabelLine(f, c, !0) && (v.push(d.id), m.push(d.id)),
            this._needLabel(f, c, !0) && (v.push(p.id), m.push(h.id)),
            h.hoverConnect = v,
            p.hoverConnect = m,
        ...
        getPolygon: function(e, t, n, r, i, s, u, a) {
            ...
            return this.deepQuery([l, f, this.option], "calculable") && (this.setCalculable(g), g.draggable = !0),
            new o(g)
        },
        getLabel: function(e, t, n, i, s, o, u, a) {
            ...
            x,
            T = n;
            g.position = g.position || p.normal.label.position,
            g.position == "inner" || g.position == "inside" ? (S = "center", x = i + o / 2, Math.max(o, u) / 2 > v.getTextWidth(w, E) ? T = "#fff": T = d.reverse(n)) : g.position == "left" ? (S = "right", x = b == "auto" ? c.x - 10 : c.centerX - Math.max(o, u) / 2 - b) : (S = "left", x = b == "auto" ? c.x + c.width + 10 : c.centerX + Math.max(o, u) / 2 + b);
            var N = {
                zlevel: this._zlevelBase + 1,
                style: {
                    x: x,
        ...
        getLabelText: function(e, t, n) {
            ...
            if (typeof o == "string") return o = o.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"),
            o = o.replace("{a0}", i.name).replace("{b0}", s.name).replace("{c0}", s.value),
            o
        },
...
function(e) {
    ...
    return a.prototype = {
        ...
        _getReformedLabel: function(e) {
            ...
            return n && (typeof n == "function" ? t = n(t) : typeof n == "string" && (t = n.replace("{value}", t))),
            t
        },
        _getInterval: function() {
        ...
        _buildAxisTick: function() {
            ...
            if (this.isHorizontal()) {
                ...
                h;
                for (var p = l; p < t; p += u) h = this.subPixelOptimize(this.getCoordByIndex(p) + (p >= 0 ? f: 0), o),
                e = {
                    _axisShape: "axisTick",
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                ...
                v;
                for (var p = l; p < t; p += u) v = this.subPixelOptimize(this.getCoordByIndex(p) - (p >= 0 ? f: 0), o),
                e = {
                    _axisShape: "axisTick",
                    zlevel: this._zlevelBase,
                    hoverable: !1,
        ...
        _buildSplitLine: function() {
            ...
            if (this.isHorizontal()) {
                ...
                c = this.grid.getYend(),
                h;
                for (var p = 0; p < t; p += this._interval) h = this.subPixelOptimize(this.getCoordByIndex(p) + f, s),
                e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {
                ...
                v = this.grid.getXend(),
                m;
                for (var p = 0; p < t; p += this._interval) m = this.subPixelOptimize(this.getCoordByIndex(p) - f, s),
                e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {
        ...
        _buildSplitArea: function() {
            ...
            if (n instanceof Array) {
                ...
                if (this.isHorizontal()) {
                    ...
                    l = this.grid.getX(),
                    c;
                    for (var h = 0; h <= s; h += this._interval) c = h < s ? this.getCoordByIndex(h) + u: this.grid.getXend(),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
                    ...
                    v = this.grid.getYend(),
                    m;
                    for (var h = 0; h <= s; h += this._interval) m = h < s ? this.getCoordByIndex(h) - u: this.grid.getY(),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
        ...
        refresh: function(e) {
            e && (this.option = this.reformOption(e), this.option.axisLabel.textStyle = o.merge(this.option.axisLabel.textStyle || {},
            this.ecTheme.textStyle)),
            this.clear(),
            this._buildShape()
        },
        ...
        getCoord: function(e) {
            ...
            for (var s = 0; s < n; s++) {
                if (t[s] == e || typeof t[s].value != "undefined" && t[s].value == e) return this.isHorizontal() ? i = this.grid.getX() + i: i = this.grid.getYend() - i,
                i;
                i += r
            }
        },
...
define("echarts/component/valueAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "../component"],
function(e) {
    ...
    return u.prototype = {
        ...
        _buildAxisTick: function() {
            ...
            if (this.isHorizontal()) {
                ...
                f;
                for (var l = 0; l < n; l++) f = this.subPixelOptimize(this.getCoord(t[l]), u),
                e = {
                    _axisShape: "axisTick",
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                ...
                h;
                for (var l = 0; l < n; l++) h = this.subPixelOptimize(this.getCoord(t[l]), u),
                e = {
                    _axisShape: "axisTick",
                    zlevel: this._zlevelBase,
                    hoverable: !1,
        ...
        _buildSplitLine: function() {
            ...
            if (this.isHorizontal()) {
                ...
                l = this.grid.getYend(),
                c;
                for (var h = 0; h < n; h++) c = this.subPixelOptimize(this.getCoord(t[h]), o),
                e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {
                ...
                d = this.grid.getXend(),
                v;
                for (var h = 0; h < n; h++) v = this.subPixelOptimize(this.getCoord(t[h]), o),
                e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {
        ...
        _buildSplitArea: function() {
            ...
            if (t instanceof Array) {
                ...
                if (this.isHorizontal()) {
                    ...
                    a = this.grid.getX(),
                    f;
                    for (var l = 0; l <= s; l++) f = l < s ? this.getCoord(r[l]) : this.grid.getXend(),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
                    ...
                    p = this.grid.getYend(),
                    d;
                    for (var l = 0; l <= s; l++) d = l < s ? this.getCoord(r[l]) : this.grid.getY(),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
            ...
            if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                ...
                a = this.series.length; u < a; u++) {
                    ...
                    if (!this.series[u].stack) {
                        ...
                        for (var l = 0,
                        c = e.length; l < c; l++) n = typeof e[l].value != "undefined" ? e[l].value: e[l],
                        this.series[u].type == s.CHART_TYPE_SCATTER ? (this.option.xAxisIndex != -1 && t[f].push(n[0]), this.option.yAxisIndex != -1 && t[f].push(n[1])) : this.series[u].type == s.CHART_TYPE_K ? (t[f].push(n[0]), t[f].push(n[1]), t[f].push(n[2]), t[f].push(n[3])) : t[f].push(n)
                    } else {
                ...
                for (var u in t) {
                    e = t[u];
                    for (var l = 0,
                    c = e.length; l < c; l++) isNaN(e[l]) || (this._min = Math.min(this._min, e[l]), this._max = Math.max(this._max, e[l]))
                }
        ...
        _reformLabelData: function() {
            ...
            if (e) for (var t = 0,
            n = this._valueList.length; t < n; t++) typeof e == "function" ? this._valueLabel.push(e(this._valueList[t])) : typeof e == "string" && this._valueLabel.push(e.replace("{value}", this._valueList[t]));
            else for (var t = 0,
            n = this._valueList.length; t < n; t++) this._valueLabel.push(this.numAddCommas(this._valueList[t]))
        },
...
function(e) {
    ...
    return u.prototype = {
        ...
        reformOption: function(e) { ! e || e instanceof Array && e.length === 0 ? e = [{
            ...
            if (this.axisType == "xAxis") {
                ...
                for (var t = 0,
                n = e.length; t < n; t++) e[t].type = e[t].type || "category",
                e[t].xAxisIndex = t,
                e[t].yAxisIndex = -1
            } else {
                ...
                for (var t = 0,
                n = e.length; t < n; t++) e[t].type = e[t].type || "value",
                e[t].xAxisIndex = -1,
                e[t].yAxisIndex = t
            }
            return e
        ...
        refresh: function(t) {
            ...
            for (var o = 0; o < s; o++) this._axisList[o] && t && (!n[o] || this._axisList[o].type != n[o].type) && (this._axisList[o].dispose && this._axisList[o].dispose(), this._axisList[o] = !1),
            this._axisList[o] ? this._axisList[o].refresh && this._axisList[o].refresh(n ? n[o] : !1, this.series) : n && n[o] && (this._axisList[o] = n[o].type == "category" ? new r(this.ecTheme, this.messageCenter, this.zr, n[o], this.myChart, this.axisBase) : new i(this.ecTheme, this.messageCenter, this.zr, n[o], this.myChart, this.axisBase, this.series))
        },
        getAxis: function(e) {
        ...
        clear: function() {
            for (var e = 0,
            t = this._axisList.length; e < t; e++) this._axisList[e].dispose && this._axisList[e].dispose();
            this._axisList = []
        }
    },
    s.inherits(u, t),
...
function(e) {
    ...
    return s.prototype = {
        ...
        refixAxisShape: function(e) {
            ...
            o;
            while (s--) o = i[s],
            o.type == r.COMPONENT_TYPE_AXIS_VALUE && o._min < 0 && o._max >= 0 && (o.isHorizontal() ? t = o.getCoord(0) : n = o.getCoord(0));
...
define("echarts/component/dataZoom", ["require", "./base", "zrender/shape/Rectangle", "zrender/shape/Polygon", "../util/shape/Icon", "../config", "zrender/tool/util", "../component", "../component"],
function(e) {
    ...
    return u.prototype = {
        ...
        _getZoom: function() {
            ...
            if (t && typeof u == "undefined") {
                i = [];
                for (var a = 0,
                f = t.length; a < f; a++)(t[a].type == "category" || typeof t[a].type == "undefined") && i.push(a)
            } else u instanceof Array ? i = u: typeof u != "undefined" ? i = [u] : i = [];
            u = this.zoomOption.yAxisIndex;
            if (n && typeof u == "undefined") {
                o = [];
                for (var a = 0,
                f = n.length; a < f; a++) n[a].type == "category" && o.push(a)
            ...
            f = e.length; a < f; a++) {
                ...
                for (var l = 0,
                c = i.length; l < c; l++) if (i[l] == (e[a].xAxisIndex || 0)) {
                    r.push(a);
                    break
                }
                for (var l = 0,
                c = o.length; l < c; l++) if (o[l] == (e[a].yAxisIndex || 0)) {
                    r.push(a);
                    break
                }
        ...
        _backupData: function() {
            ...
            for (var n = 0,
            r = t.length; n < r; n++) this._originalData.xAxis[t[n]] = e[t[n]].data;
            var i = this.option.yAxis,
            o = this._zoom.yAxisIndex;
            for (var n = 0,
            r = o.length; n < r; n++) this._originalData.yAxis[o[n]] = i[o[n]].data;
            var u = this.option.series,
            a = this._zoom.seriesIndex,
            f;
            for (var n = 0,
            r = a.length; n < r; n++) f = u[a[n]],
            this._originalData.series[a[n]] = f.data,
            f.type == s.CHART_TYPE_SCATTER && this._calculScatterMap(a[n])
        },
        ...
        _buildBackground: function() {
            ...
            for (var a = 0,
            f = u.length; a < f; a++) i = Math.max(i, o[u[a]].length);
            var l = this._originalData.yAxis,
            c = this._zoom.yAxisIndex;
            for (var a = 0,
            f = c.length; a < f; a++) i = Math.max(i, l[c[a]].length);
            ...
            m;
            for (var a = 0,
            f = p.length; a < f; a++) m = typeof p[a] != "undefined" ? typeof p[a].value != "undefined" ? p[a].value: p[a] : 0,
            this.option.series[h].type == s.CHART_TYPE_K && (m = m[1]),
            isNaN(m) && (m = 0),
            d = Math.max(d, m),
            v = Math.min(v, m);
            var g = d - v,
            ...
            for (var a = 0,
            f = i; a < f; a += E) m = typeof p[a] != "undefined" ? typeof p[a].value != "undefined" ? p[a].value: p[a] : 0,
            this.option.series[h].type == s.CHART_TYPE_K && (m = m[1]),
            isNaN(m) && (m = 0),
            this.zoomOption.orient == "horizontal" ? y.push([this._location.x + b * a, this._location.y + t - 5 - Math.round((m - v) / g * (t - 10))]) : y.push([this._location.x + 5 + Math.round((m - v) / g * (e - 10)), this._location.y + w * a]);
        ...
        _synScatterData: function(e, t) {
            ...
            var f;
            for (var l = 0,
            c = t.length; l < c; l++) f = t[l].value || t[l],
            f[0] >= s && f[0] <= o && f[1] >= u && f[1] <= a && n.push(t[l]);
            return n
        },
        ...
        ondragend: function(e, t) {
            if (!this.isDragend || !e.target) return; ! this.zoomOption.realtime && this._syncData(),
            t.dragOut = !0,
            t.dragIn = !0,
        ...
        syncBackupData: function(e) {
            ...
            o = r.length; s < o; s++) {
                ...
                for (var u = 0,
                a = i.length; u < a; u++) n[s] && (n[s][u + t] = i[u])
            }
        },
...
define("echarts/component/dataRange", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "../util/shape/HandlePolygon", "../config", "zrender/tool/util", "zrender/tool/area", "zrender/tool/color", "zrender/tool/color", "../component"],
function(e) {
    ...
    return f.prototype = {
        ...
        _buildItem: function() {
            ...
            for (var g = 0; g < t; g++) i = e[g],
            v = this.getColor((t - g) * this._gap + this.dataRangeOption.min),
            s = this._getItemShape(f, l, c, h, this._selectedMap[g] ? v: "#ccc"),
            s._idx = g,
            s.onclick = this._dataRangeSelected,
            this.shapeList.push(new r(s)),
            m && (o = {
                zlevel: this._zlevelBase,
                style: {
                    x: f + c + 5,
            ...
            this.dataRangeOption.orient == "vertical" && this.dataRangeOption.x == "right" && (o.style.x -= c + 10, o.style.textAlign = "right"), o._idx = g, o.onclick = this._dataRangeSelected, this.shapeList.push(new n(o))),
            this.dataRangeOption.orient == "horizontal" ? f += c + (m ? 5 : 0) + (m ? u.getTextWidth(i, a) : 0) + p: l += h + p; ! m && this.dataRangeOption.text[1] && (this.dataRangeOption.orient == "horizontal" ? f = f - p + this._textGap: l = l - p + this._textGap, o = this._getTextShape(f, l, this.dataRangeOption.text[1]), this.dataRangeOption.orient != "horizontal" && (o.style.y -= 5, o.style.textBaseline = "top"), this.shapeList.push(new n(o)))
        },
        _buildGradient: function() {
            ...
            v = [];
            for (var m = 0,
            g = this.dataRangeOption.color.length; m < g; m++) v.push([m * d, this.dataRangeOption.color[m]]);
        ...
        _getItemGroupLocation: function() {
            ...
            if (this.dataRangeOption.orient == "horizontal") {
                ...
                c = Math.max(u.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[0] || "", a), u.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[1] || "", a)),
                s = Math.max(r, c);
                else {
                    o = (i + n) * t,
                    r += 5,
        ...
        ondragend: function(e, t) {
            if (!this.isDragend || !e.target) return; ! this.dataRangeOption.realtime && this._syncData(),
            t.dragOut = !0,
            t.dragIn = !0,
        ...
        refresh: function(e) {
            if (e) {
                ...
                this._valueTextList = [];
                for (var s = 0; s < t; s++) this._selectedMap[s] = !0,
                this._valueTextList.unshift(this._textFormat(s * this._gap + this.dataRangeOption.min, (s + 1) * this._gap + this.dataRangeOption.min))
            }
            this.clear(),
            this._buildShape()
        },
...
define("echarts/chart/scatter", ["require", "../component/base", "./base", "../util/shape/Symbol", "../component/axis", "../component/grid", "../component/dataZoom", "../component/dataRange", "../config", "zrender/tool/util", "zrender/tool/color", "../chart"],
function(e) {
    ...
    return u.prototype = {
        ...
        _buildShape: function() {
            ...
            l = e.length; f < l; f++) {
                ...
                if (r.type == i.CHART_TYPE_SCATTER) {
                    ...
                    } else this.selectedMap[s] = !0,
                    this._sIndex2ColorMap[f] = this.zr.getColor(f);
        ...
        _markMap: function(e, t, n, r) {
            ...
            s;
            for (var o = 0,
            u = r.length; o < u; o++) s = n[r[o][2]].value || n[r[o][2]],
            i.min0 > s[0] && (i.min0 = s[0], i.minY0 = r[o][1], i.minX0 = r[o][0]),
            i.max0 < s[0] && (i.max0 = s[0], i.maxY0 = r[o][1], i.maxX0 = r[o][0]),
            i.sum0 += s[0],
            i.counter0++,
            i.min1 > s[1] && (i.min1 = s[1], i.minY1 = r[o][1], i.minX1 = r[o][0]),
            i.max1 < s[1] && (i.max1 = s[1], i.maxY1 = r[o][1], i.maxX1 = r[o][0]),
            i.sum1 += s[1],
            i.counter1++;
        ...
        _buildPointList: function(e) {
            ...
            for (var o in e) {
                ...
                for (var u = 0,
                a = r.length; u < a; u++) i = r[u],
                s = this._getSymbol(o, i[2], i[3], i[0], i[1]),
...
define("echarts/chart/k", ["require", "../component/base", "./base", "../util/shape/Candle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "../chart"],
function(e) {
    function u(e, r, i, s, o) {
        t.call(this, e, r, i, s, o),
        n.call(this),
    ...
    return u.prototype = {
        ...
        _buildShape: function() {
            ...
            n;
            for (var r = 0,
            s = e.length; r < s; r++) e[r].type == i.CHART_TYPE_K && (e[r] = this.reformOption(e[r]), n = this.component.xAxis.getAxis(e[r].xAxisIndex), n.type == i.COMPONENT_TYPE_AXIS_CATEGORY && t[n.getPosition()].push(r));
        ...
        _buildSinglePosition: function(e, t) {
            ...
            for (var s = 0,
            o = t.length; s < o; s++) this.buildMark(t[s])
        },
        _mapData: function(e) {
            var t = this.series,
            ...
            o = 0;
            for (var u = 0,
            a = e.length; u < a; u++) n = t[e[u]],
            r = n.name,
            i ? this.selectedMap[r] = i.isSelected(r) : this.selectedMap[r] = !0,
            this.selectedMap[r] && s.push(e[u]),
            o = Math.max(o, n.data.length);
            return {
                locationMap: s,
                maxDataLength: o
            }
        ...
        addDataAnimation: function(e) {
            ...
            n = {};
            for (var r = 0,
            i = e.length; r < i; r++) n[e[r][0]] = e[r];
            var o, u, a, f, l, c;
            for (var r = 0,
            i = this.shapeList.length; r < i; r++) {
...
define("echarts/component/polar", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Polygon", "../config", "zrender/tool/util", "../util/coordinates", "../component"],
function(e) {
    function a(e, n, r, i, s) {
        t.call(this, e, n, r, i, s),
        this.refresh(i)
    ...
    return a.prototype = {
        ...
        _buildShape: function() {
            for (var e = 0; e < this.polar.length; e++) this.reformOption(this.polar[e]),
        ...
        _createVector: function(e) {
            ...
            a = t.__ecIndicator = [],
            f;
            for (var l = 0; l < r; l++) f = u.polar2cartesian(o, i * Math.PI / 180 + s * l),
            a.push({
                vector: [f[1], -f[0]]
            })
        },
        ...
        _addAxisLabel: function(e) {
            ...
            for (var g = 0; g < r.length; g++) {
                ...
                if (s.show) {
                    a = {},
                    a.textFont = this.getFont(),
                    a = o.merge(a, s),
                    a.lineWidth = a.width,
                    u = i[g].vector,
                    h = i[g].value,
                    d = g / r.length * 2 * Math.PI,
                    v = s.offset || 10;
                    for (var y = 1; y <= l; y++) f = o.merge({},
                    a),
                    p = y * (h.max - h.min) / l + h.min,
                    m && (p = p.toFixed(m)),
                    f.text = this.numAddCommas(p),
                    f.x = y * u[0] / l + Math.cos(d) * v + c[0],
                    f.y = y * u[1] / l + Math.sin(d) * v + c[1],
                    this.shapeList.push(new n({
                        zlevel: this._zlevelBase,
                        style: f,
                        draggable: !1,
        ...
        _buildText: function(e) {
            ...
            for (var v = 0; v < s.length; v++) {
                ...
                u.color = d.color,
                typeof f.formatter == "function" ? u.text = f.formatter(s[v].text, v) : typeof f.formatter == "string" ? u.text = f.formatter.replace("{value}", s[v].text) : u.text = s[v].text,
                r[v].text = u.text,
                i = r[v].vector,
        ...
        getDropBox: function(e) {
            ...
            s.push(this._mapVector(o, n, 1.2));
            return u = this._getShape(s, "fill", "rgba(0,0,0,0)", "", 1),
            u
        },
        _addArea: function(e, t, n, r, i, s, o) {
            var u, a, f, l;
            for (var c = 0; c < t; c++) a = (t - c) / t,
            l = this._getPointList(e, a, n),
            o && (u = this._getShape(l, "stroke", "", i, s), this.shapeList.push(u)),
            r.show && (f = (t - c - 1) / t, this._addSplitArea(e, r, a, f, n, c))
        },
        ...
        _addSplitArea: function(e, t, n, r, i, s) {
            ...
            l = e[d].vector,
            c = e[(d + 1) % o].vector,
            h.push(this._mapVector(l, i, n)),
            h.push(this._mapVector(l, i, r)),
            h.push(this._mapVector(c, i, r)),
            h.push(this._mapVector(c, i, n)),
            p = this._getShape(h, "fill", u, "", 1),
            this.shapeList.push(p)
        },
        ...
        _addLine: function(e, t, n) {
            ...
            a = o.width,
            f = o.type;
            for (var l = 0; l < r; l++) s = e[l].vector,
            i = this._getLine(t[0], t[1], s[0] + t[0], s[1] + t[1], u, a, f),
        ...
        _adjustIndicatorValue: function(e) {
            ...
            for (var d = 0; d < r; d++) typeof n[d].max == "number" ? (o = n[d].max, u = n[d].min || 0, s = {
                max: o,
                min: u
            }) : s = this._findValue(a, d, f, l, c, h, p),
            i[d].value = s
        },
        _getSeriesData: function(e) {
            ...
            for (var o = 0; o < this.series.length; o++) {
                ...
                r = n.data || [];
                for (var u = 0; u < r.length; u++) polarIndex = this.deepQuery([r[u], n, this.option], "polarIndex") || 0,
                polarIndex == e && (!i || i.isSelected(r[u].name)) && t.push(r[u])
            }
            return t
        },
        _findValue: function(e, t, n, r, i, s, o) {
            ...
            e.length == 1 && (a = 0);
            if (e.length != 1) for (var g = 0; g < e.length; g++) f = typeof e[g].value[t].value != "undefined" ? e[g].value[t].value: e[g].value[t],
            m(f);
            else {
                v = e[0];
        ...
        getNearestIndex: function(e) {
            ...
            for (var h = 0; h < this.polar.length; h++) {
                ...
                r = this.parsePercent(t.radius, c),
                s = t.startAngle,
                o = t.indicator,
                a = o.length,
                f = 2 * Math.PI / a,
                i = u.cartesian2polar(e[0] - n[0], n[1] - e[1]),
    ...
    o.inherits(a, t),
    e("../component").define("polar", a),
    a
}),
define("echarts/chart/radar", ["require", "../component/base", "./base", "zrender/shape/Polygon", "../component/polar", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../util/accMath", "../chart"],
function(e) {
    ...
    return a.prototype = {
        ...
        _buildShape: function() {
            ...
            n;
            for (var r = 0,
            s = e.length; r < s; r++) e[r].type == i.CHART_TYPE_RADAR && (this.serie = this.reformOption(e[r]), n = this.serie.name || "", this.selectedMap[n] = t ? t.isSelected(n) : !0, this.selectedMap[n] && (this._queryTarget = [this.serie, this.option], this.deepQuery(this._queryTarget, "calculable") && this._addDropBox(r), this._buildSingleRadar(r), this.buildMark(r)));
            this.addShapeList()
        },
        ...
        _getPointList: function(e, t) {
            ...
            for (var s = 0,
            o = t.value.length; s < o; s++) r = i.getVector(e, s, typeof t.value[s].value != "undefined" ? t.value[s].value: t.value[s]),
            r && n.push(r);
            return n
        },
        _addSymbol: function(e, t, n, r, i) {
            ...
            for (var f = 0,
            l = e.length; f < l; f++) u = this.getSymbolShape(this.deepMerge([o[r].data[n], o[r]]), r, o[r].data[n].value[f], f, a.getIndicatorText(i, f), e[f][0], e[f][1], this._symbol[this._radarDataCounter % this._symbol.length], t, "#fff", "vertical"),
            u.zlevel = this._zlevelBase + 1,
            s.set(u, "data", o[r].data[n]),
            s.set(u, "value", o[r].data[n].value),
            s.set(u, "dataIndex", n),
            s.set(u, "special", f),
            this.shapeList.push(u)
        },
...
define("echarts/util/shape/Chord", ["require", "zrender/shape/Base", "zrender/tool/util"],
function(e) {
    function i(e) {
        t.call(this, e)
    }
...
define("echarts/chart/chord", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Sector", "../util/shape/Chord", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/vector", "../util/ndarray", "../chart"],
function(e) {
    ...
    return p.prototype = {
        ...
        _buildShape: function() {
            ...
            n = 0;
            for (var r = 0,
            i = e.length; r < i; r++) if (e[r].type === this.type) {
...
define("echarts/chart/force", ["require", "../component/base", "./base", "zrender/shape/Circle", "zrender/shape/Line", "../util/shape/Icon", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "zrender/tool/vector", "../util/ndarray", "../chart"],
function(e) {
    function v(e, v, y, b, w) {
        function rt() {
            ...
            n = T.length; t < n; t++) {
                ...
                if (r.type === o.CHART_TYPE_FORCE) {
                    T[t] = x.reformOption(T[t]),
                    e = T[t].name || "",
                    x.selectedMap[e] = S ? S.isSelected(e) : !0;
                    if (!x.selectedMap[e]) continue;
                    x.buildMark(t),
                    N = r;
                    var i = x.query(r, "minRadius"),
                    s = x.query(r, "maxRadius");
                    Q = x.query(r, "attractiveness"),
                    V = x.query(r, "density"),
                    $ = x.query(r, "initSize"),
                    K = x.query(r, "centripetal"),
                    J = x.query(r, "coolDown"),
                    A = x.query(r, "categories");
                    for (var u = 0,
                    f = A.length; u < f; u++) A[u].name && (S ? x.selectedMap[u] = S.isSelected(A[u].name) : x.selectedMap[u] = !0);
                    _ = x.query(r, "itemStyle.normal.linkStyle"),
                    D = x.query(r, "itemStyle.emphasis.linkStyle"),
                    O = x.query(r, "itemStyle.normal.nodeStyle"),
                    M = x.query(r, "itemStyle.emphasis.nodeStyle"),
                    P = x.query(r, "nodes"),
                    H = a.clone(x.query(r, "links")),
                    it(P, H),
                    R.length = 0,
                    U.length = 0,
                    z.length = 0,
        ...
        function it(e, t) {
            ...
            function(e, t) {
                if (!e) return;
                if (e.ignore) return;
                if (x.selectedMap[e.category]) return n[t] = r++,
                !0;
                n[t] = -1
            });
            var i, s, o;
            ...
            function(e, t) {
                ...
                s = e.target,
                o = !0,
                n[i] >= 0 ? e.source = n[i] : o = !1,
                n[s] >= 0 ? e.target = n[s] : o = !1,
                e.rawIndex = t,
                o
            })
        }
        function st(e, t, n) {
            ...
            for (var o = 0; o < s; o++) {
                ...
                T;
                x.query(N, "itemStyle.normal.label.show") && (E.style.text = f.name, E.style.textPosition = "inside", T = x.query(N, "itemStyle.normal.label.textStyle") || {},
                E.style.textColor = T.color || "#fff", E.style.textAlign = T.align || "center", E.style.textBaseline = T.baseline || "middle", E.style.textFont = x.getFont(T)),
                x.query(N, "itemStyle.emphasis.label.show") && (E.highlightStyle.text = f.name, E.highlightStyle.textPosition = "inside", T = x.query(N, "itemStyle.emphasis.label.textStyle") || {},
                E.highlightStyle.textColor = T.color || "#fff", E.highlightStyle.textAlign = T.align || "center", E.highlightStyle.textBaseline = T.baseline || "middle", E.highlightStyle.textFont = x.getFont(T)),
                a.merge(E.style, O),
                a.merge(E.highlightStyle, M);
                ...
                if (typeof f.itemStyle != "undefined") {
                    var L = f.itemStyle;
                    L.normal && a.merge(E.style, L.normal, !0),
                    L.normal && a.merge(E.highlightStyle, L.emphasis, !0)
                }
                ...
                0, f, a.indexOf(P, f), f.name || "", f.value),
                E = new r(E),
                C.push(E),
                x.shapeList.push(E),
                y.addShape(E)
        ...
        function ot(e, t) {
            ...
            for (var r = 0; r < n; r++) {
                ...
                a.merge(f.style, _),
                a.merge(f.highlightStyle, D),
                typeof o.itemStyle != "undefined" && (o.itemStyle.normal && a.merge(f.style, o.itemStyle.normal, !0), o.itemStyle.emphasis && a.merge(f.highlightStyle, o.itemStyle.emphasis, !0));
                var l = B[o.source],
                c = B[o.target],
                o = H[o.rawIndex];
                u.pack(f, N, 0, {
                ...
                o.rawIndex, l.name + " - " + c.name, o.weight || 0, !0),
                f = new i(f),
                k.push(f),
                x.shapeList.push(f),
                y.addShape(f);
        ...
        function ut() {
            ...
            n = j.length; t < n; t++) {
                ...
                s = C[r.source],
                o = C[r.target];
                i.style.xStart = s.position[0],
                i.style.yStart = s.position[1],
                i.style.xEnd = o.position[0],
                i.style.yEnd = o.position[1];
                if (N.linkSymbol) {
                    var u = L[t];
                    c.copy(u.position, o.position),
                    c.sub(e, s.position, o.position),
                    c.normalize(e, e),
                    c.scaleAndAdd(u.position, u.position, e, o.style.r + 2);
                    var a;
                    e[1] < 0 ? a = 2 * Math.PI - Math.acos( - e[0]) : a = Math.acos( - e[0]),
                    u.rotation = a - Math.PI / 2
                }
            }
        }
        function at(e) {
            ...
            p = j.length; i < p; i++) {
                ...
                c.scaleAndAdd(q[g], q[g], n, h),
                c.scaleAndAdd(q[y], q[y], n, -h)
            }
            for (var i = 0,
            p = B.length; i < p; i++) {
                var w = R[i];
            ...
            p = R.length; i < p; i++) {
                ...
                if (B[i].fixed) {
                    c.set(R[i], tt, nt),
                    c.set(U[i], tt, nt),
                    c.set(C[i].position, tt, nt),
                    d[x] !== undefined && c.set(d[x], tt, nt);
                    continue
                }
                var w = R[i],
                T = U[i];
                ...
                T[0] = w[0],
                T[1] = w[1],
                c.scaleAndAdd(E, E, q[i], e / z[i]),
                c.scale(E, E, W),
                E[0] = Math.max(Math.min(E[0], 100), -100),
                E[1] = Math.max(Math.min(E[1], 100), -100),
                c.add(w, w, E),
                S.fixY && S.initial && (w[1] = S.initial[1]),
                S.fixX && S.initial && (w[0] = S.initial[0]),
                c.copy(C[i].position, w),
                x && (d[x] || (d[x] = c.create()), c.copy(d[x], w))
            }
        }
        function ft() {
            if (W < .01) return;
    ...
    h = e("../util/ndarray"),
    p = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame ||
    function(e) {
        setTimeout(e, 16)
    },
    d = {};
    return a.inherits(v, n),
    a.inherits(v, t),
    e("../chart").define("force", v),
    v
}),
    ...
    return i.prototype = {
        ...
        buildPath: function(t, r) {
            ...
            if (r.smooth) {
                ...
                for (var l = 0; l < f - 3; l++) o = s[l * 2],
                u = s[l * 2 + 1],
                a = i[l + 1],
                t.bezierCurveTo(o[0], o[1], u[0], u[1], a[0], a[1]);
...
define("echarts/chart/line", ["require", "../component/base", "./base", "zrender/shape/BrokenLine", "../util/shape/Icon", "../util/shape/HalfSmoothPolygon", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"],
function(e) {
    ...
    function c(e, t) {
        ...
        r -= 1,
        a = "star";
        else if (a == "rectangle" || a == "arrow") n += (s - o) / 2,
        s = o;
        var f = "";
    ...
    return l.prototype = {
        ...
        _buildShape: function() {
            ...
            s;
            for (var u = 0,
            a = e.length; u < a; u++) e[u].type == this.type && (e[u] = this.reformOption(e[u]), n = e[u].xAxisIndex, r = e[u].yAxisIndex, i = this.component.xAxis.getAxis(n), s = this.component.yAxis.getAxis(r), i.type == o.COMPONENT_TYPE_AXIS_CATEGORY ? t[i.getPosition()].push(u) : s.type == o.COMPONENT_TYPE_AXIS_CATEGORY && t[s.getPosition()].push(u));
        ...
        _mapData: function(e) {
            ...
            c;
            for (var h = 0,
            p = e.length; h < p; h++) n = t[e[h]],
            u = n.name,
            this._sIndex2ShapeMap[e[h]] = this._sIndex2ShapeMap[e[h]] || this.query(n, "symbol") || this._symbol[h % this._symbol.length],
            a ? (this.selectedMap[u] = a.isSelected(u), this._sIndex2ColorMap[e[h]] = a.getColor(u), c = a.getItemShape(u), c && (c.style.iconType = "legendLineIcon", c.style.symbol = this._sIndex2ShapeMap[e[h]], a.setItemShape(u, c))) : (this.selectedMap[u] = !0, this._sIndex2ColorMap[e[h]] = this.zr.getColor(e[h])),
            this.selectedMap[u] && (o = n.stack || s + e[h], typeof i[o] == "undefined" ? (i[o] = r, f[r] = [e[h]], r++) : f[i[o]].push(e[h])),
            l = Math.max(l, n.data.length);
            return {
                locationMap: f,
                maxDataLength: l
            }
        ...
        _buildHorizontal: function(e, t, n, r) {
            ...
            for (var S = 0,
            x = n.length; S < x; S++) for (var T = 0,
            N = n[S].length; T < N; T++) s = n[S][T],
            r[s].counter > 0 && (r[s].average = (r[s].sum / r[s].counter).toFixed(2) - 0),
            h = this.component.yAxis.getAxis(i[s].yAxisIndex || 0).getCoord(r[s].average),
            r[s].averageLine = [[this.component.grid.getX(), h], [this.component.grid.getXend(), h]],
            r[s].minLine = [[this.component.grid.getX(), r[s].minY], [this.component.grid.getXend(), r[s].minY]],
            r[s].maxLine = [[this.component.grid.getX(), r[s].maxY], [this.component.grid.getXend(), r[s].maxY]];
        ...
        _buildVertical: function(e, t, n, r) {
            ...
            N = n[S].length; T < N; T++) s = n[S][T],
            r[s].counter > 0 && (r[s].average = (r[s].sum / r[s].counter).toFixed(2) - 0),
            c = this.component.xAxis.getAxis(i[s].xAxisIndex || 0).getCoord(r[s].average),
            r[s].averageLine = [[c, this.component.grid.getYend()], [c, this.component.grid.getY()]],
            r[s].minLine = [[r[s].minX, this.component.grid.getYend()], [r[s].minX, this.component.grid.getY()]],
            r[s].maxLine = [[r[s].maxX, this.component.grid.getYend()], [r[s].maxX, this.component.grid.getY()]];
            ...
            for (var N = e.length - 1; N >= 0; N--) {
                ...
                if (g.type == this.type && typeof b != "undefined") {
                    ...
                    k = b.length; C < k; C++) {
                        ...
                        x = this._isLarge(i, w);
                        if (!x) for (var L = 0,
                        A = w.length; L < A; L++) y = g.data[w[L][2]],
                        (this.deepQuery([y, g], "showAllSymbol") || n.isMainAxis(w[L][2]) && this.deepQuery([y, g], "symbol") != "none" || this.deepQuery([y, g, this.option], "calculable")) && this.shapeList.push(this._getSymbol(T, w[L][2], w[L][3], w[L][0], w[L][1], i));
        ...
        ontooltipHover: function(e, t) {
            ...
            while (o--) {
                ...
                a = i.length; u < a; u++) {
                    s = i[u];
                    for (var f = 0,
                    l = s.length; f < l; f++) r == s[f][2] && t.push(this._getSymbol(n[o], s[f][2], s[f][3], s[f][0], s[f][1], "horizontal"))
                }
            }
        },
        addDataAnimation: function(e) {
...
define("echarts/chart/bar", ["require", "../component/base", "./base", "zrender/shape/Rectangle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"],
function(e) {
    function a(e, r, i, s, o) {
        t.call(this, e, r, i, s, o),
        n.call(this),
    ...
    return a.prototype = {
        ...
        _buildShape: function() {
            ...
            o;
            for (var u = 0,
            a = e.length; u < a; u++) e[u].type == i.CHART_TYPE_BAR && (e[u] = this.reformOption(e[u]), n = e[u].xAxisIndex, r = e[u].yAxisIndex, s = this.component.xAxis.getAxis(n), o = this.component.yAxis.getAxis(r), s.type == i.COMPONENT_TYPE_AXIS_CATEGORY ? t[s.getPosition()].push(u) : o.type == i.COMPONENT_TYPE_AXIS_CATEGORY && t[o.getPosition()].push(u));
        ...
        _buildHorizontal: function(e, t, n, i) {
            ...
            for (var M = 0,
            _ = t.length; M < _; M++) for (var D = 0,
            P = t[M].length; D < P; D++) o = t[M][D],
            i[o].counter > 0 && (i[o].average = (i[o].sum / i[o].counter).toFixed(2) - 0),
            E = this.component.yAxis.getAxis(s[o].yAxisIndex || 0).getCoord(i[o].average),
            i[o].averageLine = [[this.component.grid.getX(), E], [this.component.grid.getXend(), E]],
            i[o].minLine = [[this.component.grid.getX(), i[o].minY], [this.component.grid.getXend(), i[o].minY]],
            i[o].maxLine = [[this.component.grid.getX(), i[o].maxY], [this.component.grid.getXend(), i[o].maxY]],
            i[o].isHorizontal = !0,
            this.buildMark(o)
        },
        _buildVertical: function(e, t, n, i) {
            ...
            P = t[M].length; D < P; D++) o = t[M][D],
            i[o].counter > 0 && (i[o].average = (i[o].sum / i[o].counter).toFixed(2) - 0),
            w = this.component.xAxis.getAxis(s[o].xAxisIndex || 0).getCoord(i[o].average),
            i[o].averageLine = [[w, this.component.grid.getYend()], [w, this.component.grid.getY()]],
            i[o].minLine = [[i[o].minX, this.component.grid.getYend()], [i[o].minX, this.component.grid.getY()]],
            i[o].maxLine = [[i[o].maxX, this.component.grid.getYend()], [i[o].maxX, this.component.grid.getY()]],
            i[o].isHorizontal = !1,
            this.buildMark(o)
        },
        _mapSize: function(e, t, n) {
            ...
            v = t.length; d < v; d++) {
                ...
                g = t[d].length; m < g; m++) {
                    ...
                    s[seriesIndex] = this.query(h, "barMinHeight"),
                    f = typeof f != "undefined" ? f: this.query(h, "barGap"),
                    l = typeof l != "undefined" ? l: this.query(h, "barCategoryGap")
                }
            }
            var E, S;
            if (t.length != u) if (!n) {
                E = typeof l == "string" && l.match(/%$/) ? Math.floor(e.getGap() * (100 - parseFloat(l)) / 100) : e.getGap() - l,
                typeof f == "string" && f.match(/%$/) ? (f = parseFloat(f) / 100, S = Math.floor((E - a) / ((t.length - 1) * f + t.length - u)), f = Math.floor(S * f)) : (f = parseFloat(f), S = Math.floor((E - a - f * (t.length - 1)) / (t.length - u)));
                if (S <= 0) return this._mapSize(e, t, !0)
            } else E = e.getGap(),
            f = 0,
            S = Math.floor(E / t.length),
            S <= 0 && (p = Math.floor(t.length / E), S = 1);
            else {
                E = u > 1 ? typeof l == "string" && l.match(/%$/) ? Math.floor(e.getGap() * (100 - parseFloat(l)) / 100) : e.getGap() - l: a,
                S = 0,
                f = u > 1 ? Math.floor((E - a) / (u - 1)) : 0;
...
function(e) {
    ...
    return p.prototype = {
        ...
        _buildShape: function() {
            ...
            var u;
            for (var l = 0,
            c = e.length; l < c; l++) if (e[l].type == a.CHART_TYPE_PIE) {
        ...
        _buildSinglePie: function(e) {
            ...
            for (var l = 0,
            c = r.length; l < c; l++) s = r[l].name,
            i ? this.selectedMap[s] = i.isSelected(s) : this.selectedMap[s] = !0,
            this.selectedMap[s] && !isNaN(r[l].value) && ( + r[l].value !== 0 ? o++:u++, a += +r[l].value, f = Math.max(f, +r[l].value));
            var h = 100,
            p, d = 0,
            v = n.clockWise,
        ...
        getLabelText: function(e, t, n, r) {
            ...
            if (typeof u == "string") return u = u.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{d}", "{d0}"),
            u = u.replace("{a0}", s.name).replace("{b0}", o.name).replace("{c0}", o.value).replace("{d0}", n),
            u
        },
        ...
        addDataAnimation: function(e) {
            ...
            var l, c, h, p = {};
            for (var r = 0,
            i = e.length; r < i; r++) l = e[r][0],
            c = e[r][2],
            h = e[r][3],
            t[l] && t[l].type == a.CHART_TYPE_PIE && (c ? (h || (s[l + "_" + t[l].data.length] = "delete"), p[l] = 1) : h ? p[l] = 0 : (s[l + "_-1"] = "delete", p[l] = -1), this._buildSinglePie(l));
            var d, v;
            for (var r = 0,
            i = this.shapeList.length; r < i; r++) {
                l = this.shapeList[r]._seriesIndex,
            ...
            i = f.length; r < i; r++) {
                ...
                if (n[l]) {
                    ...
                    else if (f[r].type == "text" || f[r].type == "broken-line") if (m == "delete") this.zr.delShape(f[r].id);
        ...
        onclick: function(e) {
            ...
            o = f.get(r, "dataIndex");
            for (var u = 0,
            l = this.shapeList.length; u < l; u++) if (this.shapeList[u].id == r.id) {
                s = f.get(r, "seriesIndex"),
                o = f.get(r, "dataIndex");
                if (!i._hasSelected) {
                ...
                } else r.style.x = r.style._x,
                r.style.y = r.style._y,
                r.style._hasSelected = !1,
                this._selected[s][o] = !1;
...
define("_chart", ["require", "echarts/chart/gauge", "echarts/chart/funnel", "echarts/chart/scatter", "echarts/chart/k", "echarts/chart/radar", "echarts/chart/chord", "echarts/chart/force", "echarts/chart/line", "echarts/chart/bar", "echarts/chart/pie"],
function(e) {
